 ...
 *
 * @name Reverb_Controller_Plugin_Navigation
 */
class Reverb_Controller_Plugin_Navigation extends Zend_Controller_Plugin_Abstract {
	/**
	 * Método da classe
	 * 
	 * @name includejs
	...
	public function preDispatch(Zend_Controller_Request_Abstract $request) {
		...
		if($module == "user") {
			...
			$view->navigation()->menu()->setUlClass('');
