    ...
    **/
     ...
     **/
     ...
     private function dados()
     {
          ...
          {
                $this->origem = APPLICATION_PATH . "/../arquivos/uploads/error/not_found.jpg";
    ...
    **/
     ...
     **/
     ...
     private function redimensionaCrop()
     {
		...
		imagecolortransparent($this->img_temp, imagecolorallocatealpha($this->img_temp, 0, 0, 0, 127));
          ...
          switch( $extensao_destino )
          {
               ...
               case 'bmp':
                    ...
                    else
                    {
                         ...
                         header("Last-Modified: Wed, 17 Sep 2014 19:49:25 GMT");
