...
/**
 * @see Zend_Soap_Client_arquivos
 */
require_once 'Zend/Soap/Client/arquivos.php';
...
class Zend_Soap_Client
{
     ...
     *
     * @internal
     * @param Zend_Soap_Client_arquivos $client
     ...
     * @return mixed
     */
    public function _doRequest(Zend_Soap_Client_arquivos $client, $request, $location, $action, $version, $one_way = null)
    {
    ...
    protected function _initSoapClientObject()
    {
        ...
        $this->_soapClient = new Zend_Soap_Client_arquivos(array($this, '_doRequest'), $wsdl, $options);
    }
