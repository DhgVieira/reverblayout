...
/**
 * @see Zend_Feed_Reader_Extension_Creativearquivos_Feed
 */
require_once 'Zend/Feed/Reader/Extension/Creativearquivos/Feed.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Feed_Reader_Extension_Creativearquivos_Entry extends Zend_Feed_Reader_Extension_EntryAbstract
{
    /**
    ...
    public function getLicenses()
    {
        ...
        if ($list->length) {
            ...
            $cc = new Zend_Feed_Reader_Extension_Creativearquivos_Feed(
    ...
    /**
     * Register Creative arquivos namespaces
     *
     */
    protected function _registerNamespaces()
    {
        $this->_xpath->registerNamespace('cc', 'http://backend.userland.com/creativearquivosRssModule');
    }
}
