...
class Zend_Gdata_Gapps_Extension_Login extends Zend_Gdata_Extension
{
    ...
    /**
     * True if the user has useristrative rights for this domain, false
     * otherwise.
     *
     * @var boolean
     */
     ...
     * @param boolean $user (optional) Whether the user is an useristrator
     *          or not.
    ...
    public function __construct($username = null, $password = null,
        $hashFunctionName = null, $user = null, $suspended = null,
    ...
    public function getDOM($doc = null, $majorVersion = 1, $minorVersion = null)
    {
        ...
        if ($this->_user !== null) {
            $element->setAttribute('user', ($this->_user ? "true" : "false"));
        }
    ...
    protected function takeAttributeFromDOM($attribute)
    {
        ...
        case 'user':
            if ($attribute->nodeValue == "true") {
                ...
                throw new Zend_Gdata_App_InvalidArgumentException("Expected 'true' or 'false' for apps:login#user.");
            }
            break;
        case 'agreedToTerms':
            if ($attribute->nodeValue == "true") {
    ...
    /**
     * Get the value for this element's user attribute.
     *
     * @see setuser
    ...
    {
        if (!(is_bool($this->_user))) {
            require_once('Zend/Gdata/App/InvalidArgumentException.php');
            throw new Zend_Gdata_App_InvalidArgumentException('Expected boolean for user.');
        }
        return $this->_user;
    }

    /**
     * Set the value for this element's user attribute. This indicates
     * whether this user is an useristrator for this domain.
     *
    ...
    public function __toString()
    {
        return "Username: " . $this->getUsername() .
            ...
            "\nuseristrator: " . ($this->getuser() ? "Yes" : "No") .
