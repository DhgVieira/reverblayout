 ...
 * @version    $Id: arquivos.php 23775 2011-03-01 17:25:24Z ralph $
 */


/** Define constant used to provide correct file processing order    */
/** @todo Section should be removed with ZF 2.0 release as obsolete  */
define('ZEND_SEARCH_LUCENE_arquivos_ANALYZER_PROCESSED', true);
...
/**
 * arquivos implementation of the Zend_Search_Lucene_Analysis_Analyzer interface.
 * There are several standard standard subclasses provided by Zend_Search_Lucene/Analysis
 * subpackage: Zend_Search_Lucene_Analysis_Analyzer_arquivos_Text, ZSearchHTMLAnalyzer, ZSearchXMLAnalyzer.
 *
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Zend_Search_Lucene_Analysis_Analyzer_arquivos extends Zend_Search_Lucene_Analysis_Analyzer
{
    /**
