                                ...
                                <div class="content-popover popover-2">
                                    <ul class="nm np  fs13 pop-over-list-1">
                                        ...
                                        <li class="nl bs posr popover-items popover-items-1">
                                            ...
                                            <a class="anchor" href="{$this->url(["titulo"=>{$this->createslug($produto->DS_PRODUTO_PRRC)}, "idproduto"=>{$produto->NR_SEQ_PRODUTO_PRRC}], 'produto', TRUE)}">Visualizar</a>
                                        </li>
                                        <li class="nl bs posr popover-items popover-items-1">
                                            <span class="ico ico-dd-edi"></span>
                                            <a class="anchor" href="{$this->url(['module' => 'painel', 'controller' => 'produto', 'action' => 'editar-produto', 'id' => $produto->NR_SEQ_PRODUTO_PRRC], null, true)}">Editar produto</a>
                                        </li>
                                        <li class="nl bs posr popover-items popover-items-1">
