<div class="modal-wraps-body bs" id="nfe-modal">
    ...
    <div class="posr bs nfe-modal-body">
        <label class="fs13 nfe-labels" for="nfe-modal-input">Enviar SMS para {$nome} - {$celular}</label>
        <form method="post" action="{$basePath}/painel/produto/enviar-sms" id="form-sms">
            <input type="hidden" name="celular" value="{$celular|replace:"-":""|replace:"_":""|replace:" ":""|replace:")":""|replace:"(":""}">
            <div class="reverb-input-1">
                <textarea cols="70" rows="5" name="mensagem">Hey, sabe aquela tee do {$nomeProduto} que vc tanto queria? Ela voltou! Corre pro site e garanta a sua. www.reverbcity.com</textarea>
            </div>
        </form>
