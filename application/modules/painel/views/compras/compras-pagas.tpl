                    ...
                    <tr class="green">
                        ...
                        <td class="tb-cells posr posr body-action has-pop-over last-col tb-big-options-2">
                            <ul class="indica-actions-6 lt =bs" style="width: 200px;">
                                ...
                                <li class="indica-items-2">
                                    <a class="indica-icos compras-repeat" href="{$this->url(['module' => 'painel', 'controller' => 'compras', 'action' => 'enviar-expedida', 'id' => $compra->NR_SEQ_COMPRA_COSO], null, true)}" atitle="Enviar para expedidas"></a>
                                </li>
