            ...
            <div class="lt bs posr container-contents" id="indicacoes-body">
                <div class="container">
                    <div class="row above-thead">
                        ...
                        <form method="post" class="form-etiqueta" action="{$this->url(['module' => 'painel', 'controller' => 'compras', 'action' => 'gerar-etiqueta'], null, true)}" target="_blank">
                            <div class="tiny-block lt first">
                                <label class="tiny-head-labels lt" for="nfe">Gerar Etiquetas:</label>
                                <input class="tiny-head-inputs lt" type="text" id="posicao" name="posicao" placeholder="999" required>
                                <button class="tiny-block-submit lt">GERAR!</button>
                            </div>
                        </form>
                        <form method="post" class="form-nfe" action="{$this->url(['module' => 'painel', 'controller' => 'compras', 'action' => 'gerar-nfe'], null, true)}" target="_blank">
                            <div class="tiny-block lt last">
                                <label class="tiny-head-labels lt" for="nfe">Gerar NFE:</label>
                                <input class="tiny-head-inputs lt" type="text" id="nfe" name="nfe" placeholder="999" value="{$dadosNotaFiscal->NR_SEQNF_NFRC + 1}">
                                <button class="tiny-block-submit lt">GERAR!</button>
                            </div>
                        </form>
                        ...
                        <form action="{$this->url(['module' => 'painel', 'controller' => 'compras', 'action' => 'busca'], null, true)}" method="post">
                            ...
                            <input type="text" name="termo" class="thead-search-field min rt bs">
                        </form>
                    </div>
                                ...
                                <tr class="green">
                                    ...
                                    <td class="tb-cells posr body-pgto">
                                        <div>
                                            ...
                                            {elseif $compra->DS_FORMAPGTO_COSO == 'amex'}
                                                <img src="{$basePath}/arquivos/painel/images/american-express.png" alt="">
                                            {/if}
                                        </div>
                                    </td>
                                    ...
                                    <td class="tb-cells posr posr body-action has-pop-over last-col tb-big-options-2">
                                        <ul class="indica-actions-6 lt =bs">
                                            ...
                                            <li class="indica-items-2">
                                                <a class="indica-icos compras-nope cancelar-compra" data-idpedido="{$compra->NR_SEQ_COMPRA_COSO}" href="{$this->url(['module' => 'painel', 'controller' => 'compras', 'action' => 'cancelar', 'id' => $compra->NR_SEQ_COMPRA_COSO], null, true)}" atitle="Cancelar"></a>
                                            </li>
                                            <li class="indica-items-2">
                                                <a class="indica-icos compras-check confirmar-compra" data-idpedido="{$compra->NR_SEQ_COMPRA_COSO}" href="{$this->url(['module' => 'painel', 'controller' => 'compras', 'action' => 'confirmar-pagamento', 'id' => $compra->NR_SEQ_COMPRA_COSO], null, true)}" atitle="Confirmar&#10; pagamento"></a>
                                            </li>
