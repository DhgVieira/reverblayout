...
class Checkout2Controller extends Zend_Controller_Action {
    ...
    public function init() {
        ...
        ->setGcFreq(10)//especifica a cada quantas vezes o garbage collector vai rodar para eliminar as imagens invÃ¡lidas
...
//                                        $model_cestas->insert($data_cesta);
                    ...
                    //$vencimentoBoleto = date('Y-m-d', strtotime("+3 days"));
                    //date(DATE_ISO8601, strtotime("+3 days"));
...
//								</tr>";
                ...
                $mensagem_baixo .= "<tr border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
                                                    <td colspan=\"15\" bgcolor=\"#FFFFFF\">
                                                            <a href='{$this->view->boleto_url}' style=\"text-decoration:none; font-family:Verdana; font-size:12px; text-align: center; color: #FFFFFF; background-color: #e85238; color: #FFF; width: 150px; height: 50px; border: none; float:right; padding: 15px; line-height: 50px;\">
                                                             IMPRIMIR BOLETO 
                                                             </a>
                                                     </td>
                            </tr>";
