            ...
            {if $dadosProduto['tipo'] neq 9}
                <li class="mycart-content-item" data-idestoque="{$dadosProduto['idestoque']}" data-valorproduto="{$valor_produto}" data-desconto="{$desconto}">
                    ...
                    <div class="mycart-content-description">
                        ...
                        <p class="mycart-content-info">{$dadosProduto['sigla']}</p>
                    </div>
...
<div class="carrinho-pagamento" style="display: block;">
    ...
    <div class="mycart-buttons clearfix">
        ...
        {*<form method="POST" action="{$this->url([], "fazerpedidocheckout", TRUE)}" class="mycart-button md-trigger">
        <form id="mycart-payment" action="{$this->url([], "fazerpedidocheckout", TRUE)}" method="post" class="mycart-button pedido avancar md-trigger" >

            <script id="pagarme" type="text/javascript"
                    ...
                    data-amount="{$dadosProduto['total_produto']|number_format:2:",":"."}"
                    data-max-installments="4"
                    data-ui-color="#6ec6a4"
                    data-button-text="Pagar"
                    data-encryption-key="ek_live_r4PoyMJEm9o1qdezLoLQ6YRULYcRdk"
...
{*var btnSubmit = document.getElementsByClassName('pagarme-checkout-btn')[0];*}
