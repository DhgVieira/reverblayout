...
<div class="rvb-fundoverde">
    ...
    <p id="quemsomos-enderecos">
        ...
        São Paulo @ (GABI PASSAR LOCAL) <br>
    ...
    <ul id="rvb-staff">
        ...
        <li id="staff-chloe">
            <div class="flip-container">
                <div class="flipper">
                    <div class="front">
                        <img src="{$basePath}/arquivos/default/images/quem-somos/reverbtoy.png" alt="Foto de Reverbtoy - Mascote Reverbcity">
                    </div>
                    <div class="back">
                        <h2 class="who">Reverb Toy</h2>
                        <p class="overview"> O Reverbtoy surgiu quando Tony<br> 
                        Strauss juntou todos os convites <br>
                        de shows que foi durante a vida, por<br>
                        isso mesmo ele já nasceu cheio de <br>
                        histórias e gostando de boa música.<br>
                        Aqueles pedaços de papeis não<br> poderiam se 
                        perder com o tempo e a força da boa música</br>
                        tratou de transformá-los no mascote da Reverbcity.</p>
        ...
        <li id="staff-gustavo">
            <div class="flip-container">
                <div class="flipper">
                    <div class="front">
                        <img src="{$basePath}/arquivos/default/images/quem-somos/gustavo.png" alt="Foto de Gustavo - Programador da Reverbcity">
                    </div>
                    <div class="back">
                        <h2 class="who"><a href="{$basePath}/perfil/gustavo-cassoto/32609" target="_blank">Gustavo</a></h2>
        ...
        <li id="staff-caio">
            <div class="flip-container">
                <div class="flipper">
                    <div class="front">
                        <img src="{$basePath}/arquivos/default/images/quem-somos/caio.png" alt="Foto de Caio - Diretor de Arte da Reverbcity">
                    </div>
                    <div class="back">
                        <h2 class="who"><a href="{$basePath}/perfil/caio-arias/3388" target="_blank">Caio</a></h2>
            ...
            <div class="flip-container">
                <div class="flipper">
                    ...
                    <div class="back">
                        ...
                        <p class="overview">I'm burning, I'm burning<br>
                        Burn burning, bubur<br>
                        I'm burning,<br>
            ...
            <div class="flip-container">
                <div class="flipper">
                    ...
                    <div class="back">
                        <h2 class="who">Reverb Toy</h2>
                        <p class="overview">
                            O Reverbtoy surgiu quando Tony<br>
                            Strauss juntou todos os convites de<br>
                            shows que foi durante a vida, por<br>
                            isso mesmo ele já nasceu cheio de<br>
                            histórias e gostando de boa música.<br>
                            Aqueles pedaços de papeis não poderiam<br>
                            se perder com o tempo e a força<br>
                            da boa música tratou de<br>
                            transformá-los no mascote <br>
                            da Reverbcity.
                        </p>
                    </div>
                </div>
