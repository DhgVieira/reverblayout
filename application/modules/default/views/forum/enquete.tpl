...
{else}
    {* Aqui mostra caso exibe resultado seja igual a 0 :( *}
            ...
            <ul class="list-of-polls">
                ...
                {foreach from=$resultado item=alternativa}
                    ...
                    <li class="poll-item">
                        ...
                        <div class="right">
                            <div class="left qtd-votos"><p>{$alternativa->quantidade_votos}</p><span>Votos</span></div>

                            <div class="resultado left" id="resultado-{counter}" data-dimension="56" data-text="{$porcentagem|truncate:4:"":TRUE}%"  data-width="30" data-fontsize="10" data-percent="{$porcentagem|truncate:4:"":TRUE}" data-fgcolor="#61c099" data-bgcolor="#fff"></div>
    ...
    {else}
        ...
        <div class="rvb-forum-details no-bg clearfix">
            <p>{$enquete->descricao}</p> <h1>naooo</h1>
        </div>
        <ul class="list-of-polls">
            {foreach from=$resultado item=alternativa}
                {assign var="porcentagem" value={math equation="(( x / y ) * z )" x=$alternativa->quantidade_votos y=$alternativa->total_votos z=100}}
    ...
    <div class="rvb-content-item clearfix">
        <form action="{$this->url(["idenquete"=>{$enquete->idenquete}], "comentarenquete", TRUE)}" method="post">
            ...
            <div class="send-button clearfix">
                <button type="submit" class="rvb-new-item md-trigger small">Enviar comentário</button>
            </div>
        </form>
    </div>
</div>
