...
<div>
    ...
    <div class="rvb-forum-form clearfix">
        <div class="box right">
            <form action="{$this->url([], 'forum', TRUE)}" id="topbar-search-desktop" class="rvb-search-box"
                  method="post">
                <input type="text" name="busca_post" id="busca_forum" placeholder="Busca">
                <hr class="separador"/>
    ...
    {if $idusuario eq 2 or $idusuario eq 6605 or $idusuario eq 4162 or $idusuario eq 32609}
        ...
        <div class="rvb-forum-search-post small">Enquete</div>
    ...
    {else}
        ...
        <div class="rvb-forum-search-post">Enquete</div>
        ...
        {foreach from=$topicos item=topico}
            <tr class="row-content">
                <td class="rvb-table-lists-item content">
                    <a class="topic-title" href="{$this->url(["titulo"=>{$this->createslug($topico->DS_TOPICO_TOSO)}, "idforum"=>{$topico->NR_SEQ_TOPICO_TOSO}], 'detalheforum', TRUE)}">
                        {$topico->DS_TOPICO_TOSO}
                    </a>
                    <p>Post <abbr class="timeago" title="{$topico->DT_ULTIMOPOST_TOSO|date_format:"%B %e, %Y"}">{$topico->DT_ULTIMOPOST_TOSO|date_format:"%B %e, %Y"}</abbr> by
