...
{if $acaoAtual eq "index"}
    {assign var="acaoAtual" value="loja2"}
{/if}
...
<section class="products">
    <h1 class="rvb-title">camisetas <span style="margin-left: 0px;">lollapalooza 2015</span></h1>
    ...
    <span class="breadcrumb">
        <div style="float: left; display: inline-block;" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
            ...
            <div style="display: inline-block;" itemprop="child" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                ...
                <div style="display: inline-block;" itemprop="child" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                    <a itemprop="url" itemprop="title" href="https://www.reverbcity.com/camisetas-lollapalooza-2015">
                        <span itemprop="title"><b>Lollapalooza 2015</b></span>
                    </a>
                </div>
            </div>
        </div>
    ...
    {*<div style="float: left;" itemprop="child" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" itemprop="title" href=""><span itemprop="title">Loja</span></a> > </div>*}
    {*</span>*}
        ...
        <div class="rvb-column left">
            ...
            <ul class="rvb-collection-of-products">
                {foreach from=$contadores item=produto name=produtosForEach}
                    ...
                    <li class="rvb-product-item" style="height: 240px;">
                        <a rel="nofollow" href="{$this->url(["titulo"=>{$this->createslug($slug)}, "idproduto"=>{$produto->NR_SEQ_PRODUTO_PRRC}], 'produto', TRUE)}" class="product-photo">
                            {if file_exists("arquivos/uploads/fotosprodutos/$foto_completa")}
                                ...
                                <span data-picture data-alt="Camiseta {$produto->DS_PRODUTO_PRRC}" data-title="Camiseta {$produto->DS_PRODUTO_PRRC}">
                                {if $_isMobile neq 1}
                                ...
                                {/if}
                                    ...
                                    <noscript>
                                        <img src="{$this->Url(['tipo'=>"fotosprodutos", 'crop'=>1, 'largura'=>160, 'altura'=>185, 'imagem'=>$foto_completa],"imagem", TRUE)}" alt="Camiseta {$produto->DS_PRODUTO_PRRC}" title="Camiseta {$produto->DS_PRODUTO_PRRC}">
                                    </noscript>
                            </span>
                            {else}
                                <!-- Polyfill para imagens responsivas-->
                        ...
                        <h2 class="product-name product-name2" style="height: auto !important; width: 100%!important; white-space: normal !important;">
                            ...
                            <a href="{$this->url(["titulo"=>{$this->createslug($slug)}, "idproduto"=>{$produto->NR_SEQ_PRODUTO_PRRC}], 'produto', TRUE)}">
                                Camiseta {$produto->DS_PRODUTO_PRRC}
                            </a>
                        </h2>
