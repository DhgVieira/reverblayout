                ...
                <div class="span9 images">
                    ...
                    <div class="image span13">
                        {if file_exists("arquivos/uploads/produtos/$foto_completa")}
                            <img src="{$this->Url(['tipo'=>"produtos", 'crop'=>1, 'largura'=>443, 'altura'=>494, 'imagem'=>$foto_completa],"imagem", TRUE)}" id="zoom_01" data-zoom-image="{$this->Url(['tipo'=>"produtos", 'crop'=>1, 'largura'=>886, 'altura'=>988, 'imagem'=>$foto_completa],"imagem", TRUE)}" alt="{$produto->DS_PRODUTO_PRRC}" max-height="100%"/>
                        {else}
