...
<div class="carrinho-pagamento" style="display: block;">
    ...
    <div class="mycart-buttons clearfix">            
        ...
        <form method="POST" action="{$this->url([], "fazerpedido2", TRUE)}" class="mycart-button pedido avancar md-trigger">                
            <script type="text/javascript"
                    src="https://pagar.me/assets/checkout/checkout.js"
                    data-button-text="Pagar"
                    data-encryption-key="ak_live_oFTsUUkB2uBBJboQqhvyzcF2m9TnKl"
                    data-amount="{$dadosProduto['total_produto']|number_format:2:"":""}"
                    data-customer-data = "false"
                    data-ui-color = "#5fbf98"
