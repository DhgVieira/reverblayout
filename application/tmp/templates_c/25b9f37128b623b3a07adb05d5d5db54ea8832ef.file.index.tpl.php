<?php /* Smarty version Smarty-3.0.7, created on 2015-10-26 00:24:43
         compiled from "/users/design/reverbcity/site/reverbcity.com/application/modules/default/views/teste/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:839319843562d8eeb5dcd86-43995996%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '25b9f37128b623b3a07adb05d5d5db54ea8832ef' => 
    array (
      0 => '/users/design/reverbcity/site/reverbcity.com/application/modules/default/views/teste/index.tpl',
      1 => 1445826187,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '839319843562d8eeb5dcd86-43995996',
  'function' => 
  array (
  ),
...
<div class="carrinho-pagamento" style="display: none;">
    <form id="mycart-payment" action="<?php echo $_smarty_tpl->getVariable('this')->value->url(array(),"fazerpedidocheckout",true);?>
" method="post" doSubmit('#mycart-payment');>
...
">
    ...
    <script type="text/javascript">
        function doSubmit(form_id) {
            ...
            console.log(data);
            jQuery("#spinner").show();
            jQuery.ajax("<?php echo $_smarty_tpl->getVariable('this')->value->url(array(),"fazerpedidocheckout",true);?>
", {
                data : data,
