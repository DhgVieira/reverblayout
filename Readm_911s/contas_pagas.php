        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      ...
                      <li style="width: 125px;" id="abaVerP" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">CONTAS PAGAS</li>
            ...
            <tr>
                ...
                <div id="abas">
                   ...
                   <div id="pagas">
                   <table width="885">
                   <tr><form action="contas_pagas.php" method="post" name="formpagas">
                   ...
                   <input name="tp" type="hidden" value="P" />
                	<ul class="compras">
                    <li>
                    <table border="0" cellpadding="0" cellspacing="2" height="20">
                            <tr>
                                ...
                                <td align="left" width="132"><strong style="color:#993300;">SubCategoria</strong></td>
                                <td align="left" width="132"><strong style="color:#993300;">Descrição</strong></td>
						  ...
						  if (mysql_num_rows($st) > 0) {
                            ...
                            <table border="0" width="1110" cellpadding="0" cellspacing="2" height="20">
                                <tr>
                                    ...
                                    <td align="center" width="25"><a href="#" onclick="confirma_liq(<?php echo $id_conta;?>,'P','P');" title="Mover para Contas A Pagar"><img src="img/ico_classicsp.gif" border="0" /></a></td>
