...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta charset="UTF-8">
        <title>Promo Caneca/Poster</title>
        <style>
            body {
    ...
    <body>
                ...
                <td valign="top" align="center">
                    <div id="shop" style="background-color: white;">
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $sqlCompra = "SELECT 
                                            GROUP_CONCAT(nr_seq_compra_coso
                                                SEPARATOR ', ')
                                        FROM
                                            (SELECT 
                                                nr_seq_compra_coso
                                            ...
                                            WHERE
                                                ...
                                                and DT_COMPRA_COSO >= '2015-03-05 00:00:00'
                                            GROUP BY nr_seq_compra_coso
                                            HAVING GROUP_CONCAT(NR_SEQ_CATEGORIA_PRRC
                                                SEPARATOR ', ') LIKE '%186%'
                                                AND (GROUP_CONCAT(NR_SEQ_CATEGORIA_PRRC
                                                SEPARATOR ', ') LIKE '%173%'
                                                OR GROUP_CONCAT(NR_SEQ_CATEGORIA_PRRC
                                                SEPARATOR ', ') LIKE '%57%')) AS compras_temp";
                            $stCompra = mysql_query($sqlCompra);
                            $rowCompra = mysql_fetch_row($stCompra);
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                     ...
                                     NR_SEQ_COMPRA_COSO in(".$rowCompra[0].")
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">Promo Caneca/Poster</strong></td>
            </tr>
            <tr bgcolor="silver">
