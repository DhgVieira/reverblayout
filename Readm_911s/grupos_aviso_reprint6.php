...
$PHP_SELF = "grupos_aviso_reprint6.php";
        	...
        	<tr>
            	<td height="20" align="center" class="textostabelas">
                	<ul id="titulos_abas">
                      ...
                      <li style="width: 120px;" id="menuDepo6" onMouseOver="trataMouseAba(this);" class="abaativa">Almofadas</li>
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <div id="listaprodutos" style="width: 990px;">
                            ...
                            and (NR_SEQ_TIPO_PRRC = 139 or NR_SEQ_CATEGORIA_PRRC = 46) AND ST_JACOMPROU_AVRC = 'N' and NR_SEQ_LOJAS_PRRC = $SS_loja ";
                            ...
                            if (mysql_num_rows($st) > 0) {
                                ...
                                while($row = mysql_fetch_row($st)) {
                                    ...
                                    <div style="text-align: center; clear: both; width: 100%; font-size: 11px;"><?php echo $strtmanahos ?></div>
                                      ...
                                      ?>
                                      <a href="grupos_aviso3.php?ch=1&palavra=<?php echo $ds_prod_url; ?>"><img src="../images/produtos/<?php echo $id_prod; ?>.<?php echo $ds_ext; ?>" border="0" alt="<?php echo $ds_prod; ?>" width="120" /></a>
                                      <?php } ?>
