        	...
        	<tr>
            	<td height="20" align="center" class="textostabelas">
                	<ul id="titulos_abas">
                      ...
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abaativa">Bones</li>
            ...
            <tr>
                ...
                <div id="listaprodutos" style="width: 990px;">
                            ...
                            from aviseme, produtos, produtos_tipo where NR_SEQ_PRODUTO_AVRC = NR_SEQ_PRODUTO_PRRC and NR_SEQ_TIPO_PRRC = NR_SEQ_CATEGPRO_PTRC
                             and NR_SEQ_CATEGORIA_PRRC = 35 AND ST_JACOMPROU_AVRC = 'N' and NR_SEQ_LOJAS_PRRC = $SS_loja 
                             AND DS_PRODUTO2_PRRC like '%bone%'
                            ";
