...
<table width="<?php echo $largura; ?>" >
	...
	<tr>
        ...
        <td class="font16" align="center" height="70"><strong>Relat&oacute;rio de Vendas de Camisetas por Estados</strong><br /><font size="-1">M&ecirc;s <?php echo $mesrequ?>/<?php echo $anorequ?></font></td>
