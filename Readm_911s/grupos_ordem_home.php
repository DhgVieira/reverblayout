...
$PHP_SELF = "grupos_ordem_home.php";
if (!$pagina) {
 $pagina = 1;
}
?>
...
$(document).ready(function(){ 
	...
	$(function() {
		$("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("grupos_ordem_up_home.php", order, function(theResponse){
        	...
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      ...
                      <li id="abaPos6" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Ordem Home</li>
                    </ul>
                </td>
            </tr>
            <tr>
        		...
        		<div id="Pos" style="width:1050px">                    
                    ...
                    <div id="contentLeft">
						 ...
						 <?php
                          ...
                          $sql .= "ORDER BY NR_ORDEM_HOME_PRRC, DT_CADASTRO_PRRC desc ";
                ...
                $fotoRow = mysql_fetch_row($stFoto);
                      ...
                      <ul class="paginacao" style="width: 900px;">
                        ...
                        $consulta = "select count(*)
                                 from produtos, estoque, produtos_tipo WHERE NR_SEQ_PRODUTO_PRRC = NR_SEQ_PRODUTO_ESRC AND NR_SEQ_LOJAS_PRRC = 1
                                 AND DS_CLASSIC_PRRC = 'N' AND NR_QTDE_ESRC > 0 AND ST_PRODUTOS_PRRC = 'A' AND NR_SEQ_TIPO_PRRC = NR_SEQ_CATEGPRO_PTRC ";
                        //$consulta .= "and NR_SEQ_TIPO_PRRC = 6 ";
