...
function confirmaCSME(idcomp) {
    var confirma = confirm("Confirma o Cancelamento dessa compra sem voltar a quantidade dos itens no estoque?")
    if ( confirma ){
        document.location.href='compras_sta.php?pg=<?php echo $pagina; ?>&st=<?php echo $status; ?>&stn=CSME&idgrp='+idcomp;
    } else {
        return false
    } 
//     window.open('compras_sta.php?pg=<?php echo $pagina; ?>&st=<?php echo $status; ?>&stn=C&idgrp='+idcomp);    
                          ...
                          if (mysql_num_rows($st) > 0) {
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0" height="30" bgcolor="<?php echo $bg; ?>">
                                <tr>
                                    ...
                                    <?php }?>
                                    <?php if ($status != "C" && $status != "CSME") {?>
                                    <td align="center" width="32"><a href="#" title="Cancelar Compra" onclick="confirmaC(<?php echo $id_compra;?>);"><img src="img/ico_cancel.gif" width="16" height="16" border="0" /></a><a href="#" title="Cancelar Compra SME (Sem Movimentar Estoque)" onclick="confirmaCSME(<?php echo $id_compra;?>);"><img src="img/altera_status.png" width="16" height="16" border="0" /></a></td>
                                    <?php }?>
                                    <?php if ($SS_nivel > 100) {?>
