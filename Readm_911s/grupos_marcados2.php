            	...
            	<td height="20" align="left" class="textostabelas">
                	<table width="1000">
                        <tr>
                            <td>
                        	<ul id="titulos_abas">
                              <li id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_marcados.php'">Produtos Marcados</li>
                              <li id="menuDepo" class="abaativa">Executados</li>
                            </ul>
                            </td>
                        </tr>
                    </table>
						  ...
						  if (mysql_num_rows($st) > 0) {
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            	<tr<?php if ($status == "I") echo " bgcolor=\"#FDEBDF\" "; ?>>
                                    ...
                                    <td align="center" width="25"><a href="grupos_marca2.php?idp=<?php echo $id_prod ?>&m=S" title="Desmarcar"><img src="img/printer_lock.png" border="0" /></a></td>
                                    <td align="center" width="25"><a href="grupos_marca2.php?idp=<?php echo $id_prod ?>&m=O" title="Limpar Marca"><img src="img/ico_cancel.gif" border="0" /></a></td>
