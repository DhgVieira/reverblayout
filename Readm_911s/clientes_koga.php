        	...
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      ...
                      <li id="abaGrupo" class="abainativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Clientes Grupos</li>
                    </ul>
                </td>
                <td>&nbsp;</td>
            </tr>
                            ...
                            <?php
                              ...
                              if (mysql_num_rows($st) > 0) {
                                ...
                                <a href="#" title="deletar grupo" onclick="confirma(<?php echo $id_grp; ?>);"><img src="img/cancel.png" width="16" height="16" /></a>
                                 ...
                                 <div>
                                <a href="gruposcliente_add.php?idg=<?php echo $id_grp; ?>" title="Ver E-Mails Cadastrados"><img src="img/ico-det.gif" width="16" height="16" /></a>
                                </div>
                                </li>
                                <?php
                                }
