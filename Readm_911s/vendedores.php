...
$consulta = "SELECT COUNT(*) FROM cadastros WHERE TP_CADASTRO_CACH = 2 ";
	...
	if ( confirma ){
    	...
    	<table class="textosjogos" cellpadding="0" cellspacing="0">
        	<tr>
            	<td height="20" width="130" align="center" class="textostabelas">
                	<ul id="titulos_abas">
                      <li id="menuDepo" class="abaativa">Vendedores</li>
                    </ul>
                </td>
            </tr>
        </table>
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
                ...
                </td><form action="vendedores.php" method="post" name="formnews" id="formnews">
                ...
                <div id="abas">
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="2" height="20">
                            <tr>
                                ...
                                <td align="center" width="90"><strong>Frete Grátis SP</strong></td>
						...
						<?php
						  ...
						  $sql = "select NR_SEQ_CADASTRO_CASO, DS_LOGIN_CASO, DS_NOME_CASO, DS_CIDADE_CASO, DS_UF_CASO, DS_CEP_CASO, DS_EMAIL_CASO, DS_DDDFONE_CASO,
										...
										from cadastros WHERE TP_CADASTRO_CACH = 2";
						  ...
						  if (mysql_num_rows($st) > 0) {
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="2">
                                <tr><form action="vendedores2.php" method="post">
                                    ...
                                    <td align="center" width="90">R$ <input style="width:45px;height:14px;" class="frm_pesq" type="text" name="desconto" value="<?php echo number_format($desconto,2,",",""); ?>" /></td>
