...
<title>Vendas Raglans Bones e Moletons</title>
    ...
    <div id="geral" style="background-color: white;">
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    NR_SEQ_PRODUTO_PRRC IN (5654,5655,6552,5653,5650,5651,5635,5639,5636,5640,5634,5637,5638,5641)
        ...
        <?php $sql_total = "SELECT 
                            ...
                            WHERE
                                NR_SEQ_CADASTRO_COSO not in (8074 , 22364)
                                    ...
                                    and ((DT_COMPRA_COSO > '2014-07-07 09:30:00' and DT_COMPRA_COSO < '2014-07-14 09:30:00'));";
        ...
        $sql_efetivo = "SELECT 
                            ...
                            AND
                                  NR_SEQ_LOJA_COSO = 1
                                    ...
                                    AND NR_SEQ_PRODUTO_CESO IN (5654,5655,6552,5653,5650,5651,5635,5639,5636,5640,5634,5637,5638,5641)";
       ...
       $sql_pagos = "SELECT 
                            ...
                            FROM
                                compras,cestas
                            WHERE
                            NR_SEQ_COMPRA_CESO = NR_SEQ_COMPRA_COSO AND
                                  NR_SEQ_LOJA_COSO = 1
