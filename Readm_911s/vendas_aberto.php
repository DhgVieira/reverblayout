...
<title>Vendas Black friday ' Aberto</title>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                     DS_FRETEGRATIS_PRRC, VL_PROMO_PRRC, DS_CATEGORIA_PTRC, SUM(NR_QTDE_CESO) as total, NR_SEQ_CATEGORIA_PRRC
                                    ...
                                    ((DT_COMPRA_COSO > '2013-11-28 10:30:00' and DT_COMPRA_COSO < '2013-12-30 08:00:00'))
...
?>
        ...
        <?php if($qtde_total <= 0){
         ...
         <b> Quantidade Total Vendida em Aberto:</b> <?php echo $qtde_total ?><br /><br />
