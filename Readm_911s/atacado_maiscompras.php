	...
	if ( confirma ){
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      <li id="abaVer" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Mais compraram</li>
                ...
                <div id="abas">
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="2" height="20">
                            <tr>
                                ...
                                <td align="left" width="170"><strong>Total de Compras</strong></td>
                                <td align="center" width="170"><strong>E-mail</strong></td>
						...
						<?php
						  ...
						  $sql = "SELECT 
                                    ...
                                    VL_DESCONTO_CACH,
                                    NR_QTDEMINIMA_CACH,
                                    NR_QTDEMINBUTTONS_CACH,
                                    DS_LOGIN_CASO,
                                    DS_CELULAR_CASO,
                                    DS_TWITTER_CACH,
                                    DS_FACEBOOK_CACH,
                                    NR_ATAC_VLRMIN_CACH,
                                    VL_ATAC_DESCBOLETO_CACH,
                                    ST_ATAC_FRETEGRATIS_CACH,
                                    VL_ATAC_MINREPOS_CACH,
                                    (SELECT 
                                        ...
                                        where
                                            NR_SEQ_CADASTRO_CASO = NR_SEQ_CADASTRO_COSO
                                                AND ST_COMPRA_COSO <> 'C') as total_compra
                                FROM
                                    cadastros,
                                    compras
                                WHERE
                                    NR_SEQ_CADASTRO_CASO = NR_SEQ_CADASTRO_COSO
                                        ...
                                        AND NR_SEQ_CADASTRO_CASO in (SELECT 
						  ...
						  $sql .= " GROUP BY NR_SEQ_CADASTRO_COSO order by total_compra DESC LIMIT $primeiro_registro, $num_por_pagina";
						  ...
						  if (mysql_num_rows($st) > 0) {
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="2">
                                <tr><form action="clientes_lj2.php" method="post">
                                    ...
                                    <td align="center" width="170"><?php echo $total_compras; ?></td>
