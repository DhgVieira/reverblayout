...
<title>Vendas Series 3 Meses</title>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                     ...
                                     from compras, cestas, produtos, produtos_tipo 
                                     where 
                                     ...
                                     NR_SEQ_LOJA_COSO = 1
                                     AND NR_SEQ_CATEGORIA_PRRC = 178 AND
                                     NR_SEQ_TIPO_PRRC = 6 AND
                                     ST_COMPRA_COSO <> 'C' and ST_COMPRA_COSO <> 'A' and ((DT_COMPRA_COSO > '2013-12-03 00:00:01'
                        			 and DT_COMPRA_COSO < '2014-02-03 23:59:00'))
...
$sql_efetivo = "SELECT 
    SUM(VL_PRODUTO_CESO) as total,
    SUM(NR_QTDE_CESO) as quantidade
   
FROM
    reverbcity22.compras,
    reverbcity22.produtos,
    reverbcity22.cestas,
    reverbcity22.produtos_tipo
where 
                                     NR_SEQ_COMPRA_COSO = NR_SEQ_COMPRA_CESO AND
                                     NR_SEQ_PRODUTO_CESO = NR_SEQ_PRODUTO_PRRC AND
                                     NR_SEQ_TIPO_PRRC = NR_SEQ_CATEGPRO_PTRC AND                                    
...
where 
                                     ...
                                     AND NR_SEQ_CATEGORIA_PRRC = 178 AND
                                     NR_SEQ_TIPO_PRRC = 6 AND
                                     ST_COMPRA_COSO = 'A' and ((DT_COMPRA_COSO > '2013-12-03 00:00:01'
                                     and DT_COMPRA_COSO < '2014-02-03 23:59:00'))";
...
where 
                                     ...
                                     AND NR_SEQ_CATEGORIA_PRRC = 178 AND
                                     NR_SEQ_TIPO_PRRC = 6 AND
                                     ST_COMPRA_COSO = 'C'  and ((DT_COMPRA_COSO > '2013-12-03 00:00:01'
                                     and DT_COMPRA_COSO < '2014-02-03 23:59:00'))";
