	...
	if ( confirma ){
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      <li id="abaVer" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Lojistas Cadastrados (<?php echo $total_usuarios; ?>)</li>
                      ...
                      <li id="abatipos2" class="abainativa" onMouseOver="trataMouseAba(this);" onClick="document.location.href='atacado_semcompras.php';">Nunca Compraram</li>
                    </ul>
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="2" height="20">
						...
						<?php
						  ...
						  $sql = "select NR_SEQ_CADASTRO_CASO, DS_LOGIN_CASO, DS_NOME_CASO, DS_CIDADE_CASO, DS_UF_CASO, DS_CEP_CASO, DS_EMAIL_CASO, DS_DDDFONE_CASO,
                                        ...
                                        ST_ATAC_FRETEGRATIS_CACH, VL_ATAC_MINREPOS_CACH, DT_CADASTRO_CASO
										from cadastros WHERE NR_SEQ_CADASTRO_CASO <> 3 AND TP_CADASTRO_CACH = 1";
						  ...
						  $sql .= " order by DT_CADASTRO_CASO LIMIT $primeiro_registro, $num_por_pagina";
						  ...
						  if (mysql_num_rows($st) > 0) {
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="2">
                                <tr><form action="clientes_lj2.php" method="post">
                                    ...
                                    <td align="left" width="100"><?php echo date("d/m/Y",strtotime($datadecad)); ?><br /><strong><?php echo $dsnick; ?></strong></td>
