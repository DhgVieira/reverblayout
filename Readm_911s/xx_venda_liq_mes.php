        ...
        while($row = mysql_fetch_row($st)) {
            ...
            if ($mesatual != $mes){
                if ($total_bruto > 0){
                    ...
                    <tr bgcolor="#E8E7E6">
                        ...
                        <td align="right"><strong>R$ <?php echo number_format($total_bruto-$total_tarifas-$total_fretec-$total_custo,2,",","."); ?></strong></td>
                    </tr>
                    <?php
                    $total_bruto = 0;
                    $total_fretec = 0;
            ...
            ?>
             <tr>
                ...
                <td align="center"><?php echo $parcelas ?></td>
                <td align="right">R$ <?php echo number_format($tarifasdia,2,",","."); ?></td>
                <td align="right">R$ <?php echo number_format($vlr_fretec,2,",","."); ?></td>
                <td align="right"><strong>R$ <?php echo number_format($vlr_bruto-$tarifasdia-$vlr_fretec-$custo,2,",","."); ?></strong></td>
             </tr>
             <?php
        }
    }
