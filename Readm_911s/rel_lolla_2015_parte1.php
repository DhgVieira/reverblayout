...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    and ((DT_COMPRA_COSO >= '2015-02-03 00:00:00'))
                                    AND NR_SEQ_PRODUTO_PRRC in(590, 4919, 591, 4677, 524, 4642, 2488, 5778, 5656, 5657, 5777, 5776, 5775, 5774, 4944, 527, 4947, 4504)
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">Lolla 2015</strong></td>
            </tr>
            <tr bgcolor="silver">
        ...
        <?php
            ...
            $str = "SELECT 
                    ...
                    WHERE
                        compras.DT_COMPRA_COSO >= '2015-02-03 00:00:00'
