                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
									...
									ST_COMPRA_COSO <> 'C' and ST_COMPRA_COSO <> 'A' AND NR_SEQ_TIPO_PRRC = 6 and
                                    ((DT_COMPRA_COSO > '2013-07-04 17:50:00' and DT_COMPRA_COSO < '2013-07-15 08:30:00') or (NR_SEQ_COMPRA_COSO in 
                                    (54510,54486,54519,54475,54329,54325,54344,54551,54511,54481,54353,
                                    54352,54348,54476,54337,54435,54340,54373,54372,54508,54343,54533)))
