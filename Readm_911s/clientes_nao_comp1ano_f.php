        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7">
        	<tr>
            	<td align="left" height="18">
                	<ul id="titulos_abas">
                      <li id="menuDepo" class="abaativa">Nao Compram 1 ano F (<strong><?php echo $totcads ?></strong>)</li>
                    ...
                    <table class="textostabelas" width="800" bgcolor="#F1EBD3" cellpadding="0" cellspacing="0">   
                        <tr>
                            <td align="left" height="68" bgcolor="#FFFFFF" valign="top">
                                ...
                                DS_CELULAR_CASO, DS_TWITTER_CACH from cadastros where NR_SEQ_CADASTRO_CASO not IN
                                (SELECT NR_SEQ_CADASTRO_COSO from compras where DT_COMPRA_COSO > DATE_SUB(SYSDATE(), INTERVAL 1 YEAR) AND ST_COMPRA_COSO <> 'C')
                                AND NR_SEQ_CADASTRO_CASO IN
                                (SELECT NR_SEQ_CADASTRO_COSO from compras WHERE ST_COMPRA_COSO <> 'C')
                                and DS_SEXO_CACH in ('F','Feminino') limit $primeiro_registro, $num_por_pagina";
