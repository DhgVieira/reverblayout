...
<input type="hidden" name="assunto" value="Relatorio de Contas a Receber" />
<table width="820" >
	<tr>
    <td>&nbsp;</td>
	...
	<tr>
        ...
        <td class="font16" align="center" height="70"><strong>Relatório de Contas a Receber</strong><br /><font class="font12"><? echo $dataini.' - '.$datafim;?></font></td>
...
<table width=820 >
	<tr>
    	<td height=70 align=left class=fontlogo width=200><strong>ReverbCity</strong></td>
        <td class=font16 align=center height=70><strong>Relatório de Contas a Receber</strong><br /><font class=font12>".$dataini.' - '.$datafim."</font></td>
...
<table width=820 class=font12 >
	...
	$sql = "select NR_SEQ_CONTA_CORC, NR_SEQ_CATCONTA_CORC, DS_DESCRICAO_CORC, VL_CONTA_CORC, DT_CADASTRO_CORC, DT_VCTO_CORC, DS_TIPO_CORC,
										...
										NR_SEQ_LOJA_CORC = NR_SEQ_LOJA_LJRC and DS_TIPO_CORC = 'C' AND NR_SEQ_LOJA_CORC = $loja AND
