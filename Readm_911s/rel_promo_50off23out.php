...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta charset="UTF-8">
        <title>Promo 50% off - 23/out</title>
        <style>
            body {
    ...
    <body>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    and ((DT_COMPRA_COSO > '2014-10-23 00:00:00'
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">Promo 50% off - 23/out</strong></td>
            </tr>
            <tr bgcolor="silver">
        ...
        <?php
            ...
            $str = "SELECT 
                    ...
                    FROM
                        compras
                    WHERE
                        DATE_FORMAT(compras.DT_COMPRA_COSO, '%Y-%m-%d') >= '2014-10-23'
                            AND compras.DT_COMPRA_COSO <= '2014-10-27 08:20:00'
