...
<title>Vendas 07/03 a 09/03 - Dia mulheres</title>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    AND NR_SEQ_CATEGORIA_PRRC in (49, 60, 61)
...
$sql_efetivo = "SELECT 
                    ...
                    INNER JOIN cestas ON compras.NR_SEQ_COMPRA_COSO = cestas.NR_SEQ_COMPRA_CESO
                    INNER JOIN produtos on produtos.NR_SEQ_PRODUTO_PRRC = cestas.NR_SEQ_PRODUTO_CESO
                    WHERE
                     	NR_SEQ_LOJA_COSO = 1
