...
<frameset rows="160,*" frameborder="no" border="0" framespacing="0">
  ...
  <frame src="rel_vendascliente.php?aba=<?php echo $aba; ?>&tipo=<?php echo $tipo; ?>&dataini=<?php echo $dataini; ?>&datafim=<?php echo $datafim; ?>" name="mainFrame" id="mainFrame" title="mainFrame" />
</frameset>
<noframes><body>
</body>
</noframes></html>