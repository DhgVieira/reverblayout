...
<title>Vendas 20/06 a 23/06 - Promo Canecas</title>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    and ((DT_COMPRA_COSO >= '2014-06-20 08:00:00'
                                    and DT_COMPRA_COSO <= '2014-06-23 08:30:00'))
                            ...
                            if (mysql_num_rows($st) > 0) {
                                ...
                                while($row = mysql_fetch_row($st)) {
                                    ...
                                    <div style="text-align: center;"><strong><?php echo $qtde_estoq ?></strong></div>
                                      ...
                                      ?>
                                      <a href="/produto/<?php echo urlencode($ds_prod_url); ?>/<?php echo $id_prod?>"><img src="../arquivos/uploads/produtos/<?php echo $id_prod; ?>.<?php echo $ds_ext; ?>" border="0" alt="<?php echo $ds_prod; ?>" width="120" /></a>
                                      <?php } ?>
                                     
                                      <div>                                        <p><a href="/produto/<?php echo urlencode($ds_prod_url); ?>/<?php echo $id_prod?>"><?php echo $ds_prod; ?></a>
