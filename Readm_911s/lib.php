...
function GravaLogEstoque($iduser,$nrprod,$nrtam,$dsacao,$dsobs,$qtde){
    ...
    foreach ($contatos as $key => $contato) {
        ...
        EnviaEmailNovo("atendimento@reverbcity.com","Reverbcity",$contato,"","",utf8_encode('Altera��o de estoque'), $corpo);
    }
}
...
function Valor_Produto($iddprod, $loginc, $nrtam = 0){
	...
	if (mysql_num_rows($stvlp) > 0) {
        ...
        //desconto para lojistas - somente para camisetas E BUTTONS por enquanto q nao estejam em promo��o
...
function EnviaEmailNovo($de, $denome, $para, $cc, $cco, $assunto, $conteudo){
    ...
    if (mysql_num_rows($st2) > 0) {
        ...
        if ($status != "S"){
            ...
            $mail->Username = 'atendimento@reverbcity.com'; // Usu�rio do servidor SMTP
...
function EnviaMailer($de, $denome, $para, $paranome, $cc, $assunto, $conteudo){
    ...
    if (mysql_num_rows($st2) > 0) {
        ...
        if ($status != "S"){
            ...
            $mail->Host = "smtp.gmail.com";
            $mail->SMTPAuth = true; // Usar autentica��o SMTP (obrigat�rio para smtp.seudom�nio.com.br)
            $mail->Username = 'desenvolvimento@reverbcity.com'; // Usu�rio do servidor SMTP
            ...
            $cpomail='
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <div style="background-color: #646464; padding: 8px 15px 8px 15px; font-family:Verdana;font-size:12px;color: #c2c3c4; width: 570px; margin-top: 15px;">
                            '.utf8_encode("A M�SICA QUE VESTE EST� CHEGANDO NA SUA CASA").'
                    </div>
                    </td></tr>
         ...
         case "niver":
            $cpomail='
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr><td>
                    <div style="background-color: #646464; padding: 8px 15px 8px 15px; font-family:Verdana;font-size:12px;color: #c2c3c4; width: 570px; margin-top: 15px;">
                            '.utf8_encode("PRESENTE DE ANIVERS�RIO DA REVERBCITY!").'
                    </div>
                    </td></tr>
                    <tr><td><img src="http://www.reverbcity.com/imgrast/div.gif" width="598" height="40" /></td></tr>
                </table>
         ...
         case "confpgto":
            $cpomail='
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr><td>
                    <div style="background-color: #646464; padding: 8px 15px 8px 15px; font-family:Verdana;font-size:12px;color: #c2c3c4; width: 570px; margin-top: 15px;">
                            '.utf8_encode("CONFIRMA��O DE PAGAMENTO REVERBCITY").'
                    </div>
                    </td></tr>
                    <tr><td><img src="http://www.reverbcity.com/imgrast/div.gif" width="598" height="40" /></td></tr>
                </table>
         ...
         case "codigorast":
            $cpomail='
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr><td>
                    <div style="background-color: #646464; padding: 8px 15px 8px 15px; font-family:Verdana;font-size:12px;color: #c2c3c4; width: 570px; margin-top: 15px;">
                            '.utf8_encode("CONFIRMA��O DE ENVIO").'
                    </div>
                    </td></tr>
                    <tr><td><img src="http://www.reverbcity.com/imgrast/div.gif" width="598" height="40" /></td></tr>
                </table>
         ...
         case "valepres":
            $cpomail='
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr><td>
                    <div style="background-color: #646464; padding: 8px 15px 8px 15px; font-family:Verdana;font-size:12px;color: #c2c3c4; width: 570px; margin-top: 15px;">
                         '.utf8_encode("VOC� ACABA DE GANHAR UM VALE PRESENTE NA REVERBCITY!").'
                    </div>
                    </td></tr>
                    <tr><td><img src="http://www.reverbcity.com/imgrast/div.gif" width="598" height="40" /></td></tr>
                </table>
