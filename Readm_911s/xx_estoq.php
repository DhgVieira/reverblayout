...
$str = "SELECT 
        ...
        where
            NR_SEQ_PRODUTO_ESRC = NR_SEQ_PRODUTO_PRRC
                ...
                and TP_DESTAQUE_PRRC <> 4
                AND NR_SEQ_LOJAS_PRRC = 1
                AND NR_SEQ_TIPO_PRRC NOT IN (59)
...
<h2>Lan&ccedil;amentos futuros</h2>
<table>
    <tr bgcolor="silver">
        <td align="left"><strong>TIPO</strong></td>
        <td align="left"><strong>CATEGORIA</strong></td>
...
$tot = 0;
$str = "SELECT 
    DS_CATEGORIA_PTRC as categoria,
    DS_CATEGORIA_PCRC as categoria,
    DS_PRODUTO2_PRRC as produto,
    DS_TAMANHO_TARC as tamanho,
    NR_QTDE_ESRC as quantidade_estoque,
    VL_PRODUTO_PRRC as valor,
    VL_PROMO_PRRC as promo,
    ST_PRODUTOS_PRRC as status,
    VL_PRODUTO2_PRRC as valor2,
    NR_SEQ_PRODUTO_PRRC as codigo_produto
from
    estoque,
    produtos,
    produtos_tipo,
...
$str_total = "SELECT
        ...
        inner join produtos on NR_SEQ_PRODUTO_PRRC = NR_SEQ_PRODUTO_ESRC
        ...
        AND NR_QTDE_ESRC > 0
                ...
                and TP_DESTAQUE_PRRC <> 4
                AND NR_SEQ_LOJAS_PRRC = 1
                AND NR_SEQ_TIPO_PRRC IN (6)
                AND NR_SEQ_CATEGPRO_PTRC NOT IN(4,140)";
        
$st_tamanho = mysql_query($str_total);
$tamanho_row = mysql_fetch_row($st_tamanho);
?>

<h2>Total Camisetas Por Tamanho / Sexo = <?php echo $tamanho_row[0]; ?></h2>
<?php 
...
$str_total = "SELECT
            SUM(NR_QTDE_ESRC) as total_tamanho,
            sum(NR_QTDE_ESRC * vl_promo_prrc)
        FROM 
            estoque
        INNER JOIN tamanhos on tamanhos.NR_SEQ_TAMANHO_TARC = estoque.NR_SEQ_TAMANHO_ESRC 
        inner join produtos on NR_SEQ_PRODUTO_PRRC = NR_SEQ_PRODUTO_ESRC
...
$st_tamanho = mysql_query($str_total);
$tamanho_row2 = mysql_fetch_row($st_tamanho);
?>

<h2 id="tamanho-sale">Total Camisetas Por Tamanho / Sexo = <?php echo $tamanho_row2[0]; ?> (SALE) R$ <?php echo number_format($tamanho_row2[1], 2, ",", "."); ?></h2>
<?php 
