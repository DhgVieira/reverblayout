...
function EnviaMailer($de, $denome, $para, $paranome, $cc, $assunto, $conteudo){
    ...
    if (mysql_num_rows($st2) > 0) {
        ...
        if ($status != "S"){
            ...
            $mail->Password = 'ramones@334'; // Senha do servidor SMTP
     ...
     switch($tipo){
         case "rast":
            $cpomail='
                ...
                '.$texto.'
                <a href="mailto:atendimento@reverbcity.com"><img src="http://www.reverbcity.com/imgrast/rodape.gif" width="598" height="212" border="0" /></a>
                </td></tr></table>';
            break;
         case "niver":
            $cpomail='
                ...
                '.$texto.'
                <a href="mailto:atendimento@reverbcity.com"><img src="http://www.reverbcity.com/imgrast/rodape_niver.jpg" border="0" /></a>
                </td></tr></table>';
            break;
         case "novocad":
            $cpomail='
         ...
         case "valepres":
            $cpomail='
                ...
                '.$texto.'
                <a href="mailto:atendimento@reverbcity.com"><img src="http://www.reverbcity.com/imgrast/rodape_pres.gif" border="0" /></a>
                </td></tr></table>';
            break;
         case "padrao":
            $cpomail='
         ...
         case "sistema":
            $cpomail='
                ...
                '.$texto.'
                <a href="mailto:atendimento@reverbcity.com"><img src="http://www.reverbcity.com/imgrast/rodape_sistema.gif" border="0" /></a>
                </td></tr></table>';
            break;
         case "aviseme":
            $cpomail='
