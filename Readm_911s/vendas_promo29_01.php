...
<title>Vendas 29/01 a 04/02</title>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    ST_COMPRA_COSO <> 'C' and ST_COMPRA_COSO <> 'A' and ((DT_COMPRA_COSO > '2014-01-29 15:00:00'
                    				and DT_COMPRA_COSO < '2014-02-04 08:20:00'))
...
$sql_efetivo = "SELECT 
                    ...
                    and ((DT_COMPRA_COSO > '2014-01-29 15:00:00'
                    and DT_COMPRA_COSO < '2014-02-04 08:20:00'))";
