...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    ST_COMPRA_COSO <> 'C'
                                    and NR_SEQ_TAMANHO_CESO IN(3,8)
                                    and ((DT_COMPRA_COSO >= '2015-03-19 11:00:00'))
                                    and ((DT_COMPRA_COSO <= '2015-03-20 08:22:00'))
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">Promo Tamanho M</strong></td>
            </tr>
            <tr bgcolor="silver">
        ...
        <?php
            ...
            $str = "SELECT 
                    ...
                    WHERE
                        ((DT_COMPRA_COSO >= '2015-03-19 11:00:00'))
                        and ((DT_COMPRA_COSO <= '2015-03-20 08:22:00'))
                        and NR_SEQ_TAMANHO_CESO IN(3,8)
