                                     ...
                                     <label for="nome">
                                      <table cellpadding="0" cellspacing="0" width="450">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	<select name="tipocli">
                                                	<option value="0"<?php if ($tipocli == 0) echo " selected"; ?>>Normal</option>
                                                    <option value="1"<?php if ($tipocli == 1) echo " selected"; ?>>Lojista</option>
                                                    <option value="2"<?php if ($tipocli == 2) echo " selected"; ?>>Vendedor</option>
                                                    <option value="3"<?php if ($tipocli == 3) echo " selected"; ?>>Parceiro</option>
                                                    <option value="5"<?php if ($tipocli == 5) echo " selected"; ?>>N&atilde;o Participante</option>
                                                </select>
                                            </td>
                                        </tr>
                                     </table>
