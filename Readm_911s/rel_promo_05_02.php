...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    ST_COMPRA_COSO <> 'C' 
                                    and ((DT_COMPRA_COSO >= '2015-02-05 09:20:00'))
                                    and ((DT_COMPRA_COSO <= '2015-02-09 08:40:00'))
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">Promo 05/02/2015</strong></td>
            </tr>
            <tr bgcolor="silver">
        ...
        <?php
            ...
            $str = "SELECT 
                    ...
                    FROM
                        compras
                    WHERE
                        compras.DT_COMPRA_COSO >= '2015-02-05 09:20:00'
                        and DT_COMPRA_COSO <= '2015-02-09 08:40:00'
        ...
        <table align="center">
            ...
            $str_total = "SELECT 
                        ...
                        WHERE
                            DT_COMPRA_COSO >= '2015-02-05 09:20:00'
                            and DT_COMPRA_COSO <= '2015-02-09 08:40:00'
                                AND compras.ST_COMPRA_COSO <> 'C'
