...
function confirma_baixa(idc) {
	...
	if ( confirma ){
		document.location.href='contas_baixa_c.php?idc='+idc+'&tp=C';
	} else {
		return false
	} 
}
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      ...
                      <li style="width: 125px;" id="abaVerR" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">A RECEBER</li>
            ...
            <tr>
                ...
                <div id="abas">
					...
					<div id="receber">
                    <table width="885">
                  <tr><form action="contas_areceber.php" method="post" name="formpesq2">
                   ...
                   <input name="tp" type="hidden" value="C" />
                	<ul class="compras">
                    <li>
                    <table border="0" cellpadding="0" cellspacing="2" height="20">
                            <tr>
                                ...
                                <td align="left" width="164"><strong style="color:#993300;">Descrição</strong></td>
                                <td align="left" width="120"><strong style="color:#993300;">Categoria</strong></td>
                                <td align="left" width="142"><strong style="color:#993300;">SubCategoria</strong></td>
						...
						<?php
						  $sql = "select NR_SEQ_CONTA_CORC, NR_SEQ_CATCONTA_CORC, DS_DESCRICAO_CORC, VL_CONTA_CORC, DT_CADASTRO_CORC, DT_VCTO_CORC, DS_TIPO_CORC,
						  				DS_CATEGORIA_CCRC, DS_LOJA_LJRC, NR_SEQ_SUBCATCONTA_CORC, NR_FORMA_PGTO_CORC, ST_CONTA_CORC, NR_SEQ_DESCRICAO_CORC
