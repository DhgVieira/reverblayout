...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td align="center">
                    <span style="font-size: 30px;">Relatório de vendas</span>
                </td>
            </tr>
            <tr>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT 
                                    ...
                                    ORDER BY COUNT(nr_qtde_ceso) DESC
                                    limit 80";
        ...
        <?php
            ...
            for($m = 12; $m >= 0; $m--){
                $selectPorMes = "SELECT 
                                    ...
                                    NR_SEQ_PRODUTO_PRRC,
                                    DS_PRODUTO2_PRRC,
                                    DATE_FORMAT(DATE_SUB('2015-02-09', INTERVAL ". $m ." MONTH), '%m/%Y')
                                FROM
                                    produtos
                                        INNER JOIN
                                    cestas ON NR_SEQ_PRODUTO_CESO = nr_seq_produto_prrc
                                ...
                                WHERE
                                    st_compra_coso NOT IN ('C' , 'A')
                                        AND DATE_FORMAT(dt_compra_coso, '%Y-%m') = DATE_FORMAT(DATE_SUB('2015-02-09', INTERVAL ". $m ." MONTH), '%Y-%m')
