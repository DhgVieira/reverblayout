...
$consulta .= "AND (NR_SEQ_LOJA_CASO = 2 or DS_CIDADE_CASO like '%SAO PAULO%' or DS_CIDADE_CASO like '%são paulo%' or DS_CIDADE_CASO like '%sÃ£o paulo%' or DS_CIDADE_CASO like '%sao paulo%' or DS_CIDADE_CASO like '%saopaulo%')";
	...
	if ( confirma ){
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      <li id="abaVer" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Clientes São Paulo (<?php echo $total_usuarios; ?>)</li>
                      <li id="abaGrupo" class="abainativa" onMouseOver="trataMouseAba(this);" onClick="document.location.href='clientes.php';">Clientes Site</li>
                    </ul>
                </td>
                <td>&nbsp;</td>
            </tr>
