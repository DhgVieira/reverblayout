...
fwrite($fp, '$str_menu .= "<li><a class=\"fly\" href=\"http://www.reverbcity.com/classics/classics_avise.php\" style=\"color: #67ffcd;\">Avise-me</a></li>\n"; ');
fwrite($fp, '$str_menu .= "<li><img src=\"/images/sp_mn_divisor.gif\" width=\"179\" height=\"4\" /></li>\n"; ');
...
if (mysql_num_rows($st) > 0) {
    ...
    fwrite($fp, '$str_menu .= "<li><a class=\"fly\" href=\"http://www.reverbcity.com/shop/produtos2_new.php\" style=\"color: #fbcbc4;\">Novidades</a>\n"; ');
    fwrite($fp, '$str_menu .= "		<ul>\n"; ');
