                    ...
                    <table border="0" width="1200" cellpadding="0" cellspacing="2">
						...
						<?php
						  ...
						  $sql = "select NR_SEQ_CADASTRO_CASO, DS_LOGIN_CASO, DS_NOME_CASO, DS_CIDADE_CASO, DS_UF_CASO,
                                  ...
                                  DS_TWITTER_CACH, DS_FACEBOOK_CACH, DS_LOGIN_CASO, ST_BLOQUEIOMAIL_CACH from cadastros WHERE NR_SEQ_CADASTRO_CASO <> 3 
                                  ";
                          if ($SS_loja != 2){
...
//							}
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="2">
                                <tr>
                                    ...
                                    <td align="left"><strong><?php echo utf8_encode(ChecaClubStyle($id_cad,$ds_nome)); ?></strong></td>
...
<!-- Grupos -->                    
 			        <div id="Grupos">
                    	<form action="gruposcliente_inc.php" method="post">
                          ...
                          <ul class="noticias">
                            ...
                            <?php
                              ...
                              if (mysql_num_rows($st) > 0) {
                                ...
                                <div>
                                <a href="#" title="deletar grupo" onclick="confirmaGP(<?php echo $id_grp; ?>);"><img src="img/cancel.png" width="16" height="16" /></a>
                                </div>
                                 <div>
                                <a href="gruposcliente_ver.php?idg=<?php echo $id_grp; ?>" title="Ver E-Mails Cadastrados"><img src="img/ico-det.gif" width="16" height="16" /></a>
                                </div>
                                </li>
                                <?php
                                }
								...
								echo '<li>Nenhum grupo registrado!</li>';  
							  }
                            ?>
                          </ul>
                    </div>   
                    ...
                    <div id="Nivers">
                    	<form action="clientes_nivers.php" method="post">
                                 <ul class="formularios">
                                   <li>
                                     <label for="nome_grp">
                                       Escolha o Mês:<br />
                                   ...
                                   <li>
                                     <input type="submit" id="postar" name="postar" value="Pesquisar" />
                                   </li>
                                 </ul>
                         </form>    
                    </div>   
                    ...
                    <div id="Export">
                    	<form action="clientes_exporta.php" method="" target="_blank" enctype="text/plain" style="width:720px">
                        <label for="tipo_filtro">
                          Tipo de Filtro
                          <select name="tipo_filtro">
                            <option value="0">Selecione</option>
                            <option value="1">Aniversáriantes</option>
                        ...
                        <label for="valor_filtro">
                          Busca
                          <input type="text" name="valor_filtro" placeholder="Aniversariante = Mês Aniversário, Cidade = nome da cidade, UF = Sigla"  style="width: 450px;"/>
                        </label>
                         		<ul class="formularios">
                                   <li>
                                     <label for="descricao">
                                   ...
                                   <li>
                                   		<input  type="submit" id="postar2" name="postar2" value="Gerar"/>
                                   </li>
                                 </ul>
                         </form>
                    </div>   
