...
include 'auth.php';
include 'lib.php';
$subject  = "Presente Reverb! Durante o mes do seu aniversario vc ganha 15% em itens fora de promocao http://rvb.la/FelizBday";
?>
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <div id="abas">
                    ...
                    <div id="Criar">
                         <p style="margin: 0 0 0 20px;"><strong>Enviando SMS para os aniversariantes de Hoje!!</strong></p>
                         <form action="envia_mail_sms_dia2.php" method="post">
                             <fieldset>
