        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7">
        	<tr>
            	<td align="left" height="18">
                	<ul id="titulos_abas">
                      <li id="menuDepo" class="abaativa" style="width:300px">Compradores SP Capital</li>
                      <li><input type="Button" value="Enviar p/ Todos (SMS)" onClick="document.location.href=('envia_sms_compradores_sp.php');" class="form00" style="width:120px;height:23px;margin: 0;" /></li>
                    </ul>
                </td>
            </tr>
            <tr>
                    ...
                    <table class="textostabelas" width="800" bgcolor="#F1EBD3" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td align="left" height="68" bgcolor="#FFFFFF" valign="top">
                                ...
                                $compra .= "AND (NR_SEQ_LOJA_CASO = 2 or DS_CIDADE_CASO like '%SAO PAULO%' or DS_CIDADE_CASO like '%são paulo%' or DS_CIDADE_CASO like '%sÃ£o paulo%' or DS_CIDADE_CASO like '%sao paulo%' or DS_CIDADE_CASO like '%saopaulo%')";
