...
$PHP_SELF = "grupos_aviso_reprint.php";
	...
	padding:0;
        ...
        <table class="textosjogos" cellpadding="0" cellspacing="0">
        	<tr>
            	<td height="20" align="center" class="textostabelas">
                	<ul id="titulos_abas">
                      <li style="width: 120px;" id="menuDepo" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_reprint.php'">Tees Bandas</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abaativa">Basic</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_bone.php'">Bones</li>
                      ...
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_caveira.php'">Caveiras</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_classic.php'">Classic</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_escritores.php'">Escritores</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_estilomusicais.php'">Estilos Musicais</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_filmes.php'">Filmes</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_absorvente.php'">F. do Absorvente</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_reprint2.php'">Inverno</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_poster.php'">Poster</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_raglans.php'">Raglans</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_series.php'">Series</li>
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_tipograficas.php'">Tipograficas</li>
                      <!-- 
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_reprint2.php'">Inverno</li>
                      <li style="width: 120px;" id="menuDepo3" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_reprint3.php'">Podrinhas</li>
                      ...
                      <li style="width: 120px;" id="menuDepo7" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_reprint7.php'">Eco Bags</li>
            ...
            <tr>
                ...
                <table width="880">
                        	<tr>
								...
								?>
                            	<form action="grupos_aviso_reprint.php" method="post" name="frm">
                ...
                <div id="listaprodutos" style="width: 990px;">
                            ...
                            and NR_SEQ_TIPO_PRRC = 6 and NR_SEQ_CATEGORIA_PRRC in (179) AND ST_JACOMPROU_AVRC = 'N' and NR_SEQ_LOJAS_PRRC = $SS_loja 
                            AND NR_SEQ_PRODUTO_PRRC not in (2030, 5105, 2173, 381, 4626, 2047, 836, 1533, 2041, 376, 2043, 4631, 1527, 541, 1502, 2029, 1524, 1529, 2042)";
                            ...
                            if (mysql_num_rows($st) > 0) {
                                ...
                                while($row = mysql_fetch_row($st)) {
                                    ...
                                    ?>
                                    <div idproduto="<?php echo $id_prod; ?>" class="produto"  style="margin: 0 0 7px 6px;position: relative; z-index:1; height: 265px;">
                                    ...
                                    <div style="text-align: center; clear: both; width: 100%; font-size: 11px;"><?php echo $strtmanahos ?></div>
                                      ...
                                      $ds_prod_url = str_replace("&","e;",$ds_prod);
                                        if (file_exists("../arquivos/uploads/produtos/".$id_prod.".".$ds_ext)){
                                        ?>
                                        ...
                                        <?php
                                          ...
                                          ?>
                                            <a href="grupos_aviso3.php?ch=1&palavra=<?php echo $ds_prod_url; ?>"><img src="/thumb/fotosprodutos/1/129/150/<?php echo $fotoRow[0]; ?>.<?php echo $fotoRow[2]; ?>" border="0" alt="<?php echo $ds_prod; ?>" width="120" /></a>
                                          <?php 
                                        }
                                      } ?>
