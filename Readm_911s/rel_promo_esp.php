...
$largura = 830;
$codigopromo = 5;
$primrodiacomp = "2013-10-04 15:10:00";
$ultimodiacomp = "2013-10-07 23:59:59";
?>
...
<table>
    ...
    <tr>
        <td valign=top style="font-size: 12px; padding: 10px;" colspan="3">
            <strong>PROMO&Ccedil;&Atilde;O 40% OFF</strong>
            <p>&nbsp;</p>
            <strong>Per&iacute;odo da Promo:</strong> 04/10/2013 15:10:00 a 06/10/2013 23:59:59<br />
        ...
        <td valign=top>
            <script type="text/javascript">
              ...
              function drawChart() {
                ...
                var options = {
                  title: 'Vendas por Dia Promo 40%off',
        ...
        <td valign=top>
            <script type="text/javascript">
              ...
              function drawChart() {
                ...
                var options = {
                  title: 'Camisetas Vendidas por Dia Promo 40%off - Total: <?php echo $camtot; ?>',
                  chartArea: {left: 45, width: "100%", height: "80%"},
                  legend: 'none'
                };
...
<script type="text/javascript">
              ...
              function drawChart() {
                ...
                var options = {
                  title: 'Vendas por Hora - Promo 40%off',
                  chartArea: {left: 45, width: "100%", height: "80%"},
                  legend: 'none'
                };
