...
function confirma(idc) {
	...
	if ( confirma ){
		document.location.href='people_coments_del.php?idc='+idc+'&idp=<?php echo $idp; ?>';
	} else {
		return false
	} 
}
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      <li id="abaVer" class="abainativa" onMouseOver="trataMouseAba(this);" onClick="javascript:document.location.href='people.php?pagina=<?php echo $pagina; ?>';">Fotos Cadastradas</li>
                ...
                <div id="abas">
                    ...
                    <div id="Criar">
                        ...
                        <ul class="noticias">
                            ...
                            <?
                              $sql = "select NR_SEQ_COMENTARIO_MCRC, DS_NOME_CASO, DS_TEXTO_MCRC, DT_CADASTRO_MCRC, DS_STATUS_MCRC from me_fotos_coments, cadastros WHERE NR_SEQ_CADASTRO_MCRC = NR_SEQ_CADASTRO_CASO and NR_SEQ_FOTO_MCRC = $idp order by DT_CADASTRO_MCRC desc";
                              $st = mysql_query($sql);
                              ...
                              if (mysql_num_rows($st) > 0) {
                                ...
                                <table width="860" class="noticias">
                                    <tr>
                                        ...
                                        <td width="20" align="center"><a href="people_coments_sta.php?st=<?php echo $st_post; ?>&idc=<? echo $id_coment;?>&idp=<?php echo $idp; ?>" title="Alterar Status"><img src="img/ico_cancel.gif" width="16" height="16" border="0" /></a></td>
