...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    and ((DT_COMPRA_COSO >= '2014-11-27 09:20:00'))
                                    and ((DT_COMPRA_COSO <= '2014-12-01 08:40:00'))
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">Black Friday 2014</strong></td>
            </tr>
            <tr bgcolor="silver">
        ...
        <?php
            ...
            $str = "SELECT 
                        ...
                        SUM(compras.VL_TOTAL_COSO) AS valor_total,
                        compras.DS_FORMAPGTO_COSO
                    FROM
                        compras
                    WHERE
                        compras.DT_COMPRA_COSO >= '2014-11-27 09:20:00'
                        and DT_COMPRA_COSO <= '2014-12-01 08:40:00'
        ...
        <table align="center">
            <tr>
                <td colspan="4"><strong style="font-size: 25px;">Total Camisetas Por Temas</strong></td>
            </tr>
            <tr bgcolor="silver">
                <td>Tema</td>
                <td>Quantidade</td>
            ...
            $str_total = "SELECT 
                        ...
                        FROM
                            ...
                            produtos ON nr_seq_produto_prrc = nr_seq_produto_ceso
                                INNER JOIN
                            produtos_categoria ON nr_seq_categoria_prrc = nr_seq_categpro_pcrc
                        WHERE
                            DT_COMPRA_COSO >= '2014-11-27 09:20:00'
                            and DT_COMPRA_COSO <= '2014-12-01 08:40:00'
                                AND compras.ST_COMPRA_COSO <> 'C'
                        GROUP BY NR_SEQ_CATEGPRO_PCRC
        ...
        <table align="center">
            <tr>
                <td colspan="4"><strong style="font-size: 25px;">Vendas por Valor</strong></td>
            </tr>
            <tr bgcolor="silver">
                <td></td>
                <td>Quantidade</td>
            ...
            $str_total = "SELECT 
                        ...
                        WHERE
                            DT_COMPRA_COSO >= '2014-11-27 09:20:00'
                            and DT_COMPRA_COSO <= '2014-12-01 08:40:00'
                            AND VL_TOTAL_COSO < '19.9'
                            AND compras.ST_COMPRA_COSO <> 'C'";
            
            $st_tamanho = mysql_query($str_total);
            if (mysql_num_rows($st_tamanho) > 0) {

                $row_t = mysql_fetch_row($st_tamanho);
                $total = $row_t[0];
                $qtd = $row_t[1];
