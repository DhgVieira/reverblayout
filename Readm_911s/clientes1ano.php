...
$total = "SELECT COUNT(NR_SEQ_CADASTRO_COSO) from cadastros, compras 
            ...
            (select NR_SEQ_CADASTRO_COSO from compras where ST_COMPRA_COSO <> 'C' AND (DT_COMPRA_COSO > date_add(sysdate(),INTERVAL -365 DAY)))) 
           ";
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7">
        	<tr>
            	<td align="left" height="18">
                	<ul id="titulos_abas">
                      <li id="menuDepo" class="abaativa" style="width:300px">Clientes que Compraram a mais de 1 ano (<?php echo $total_result ?>)</li>
