...
<frameset rows="160,*" frameborder="no" border="0" framespacing="0">
  ...
  <frame src="rel_contasreceber.php?aba=<?php echo $aba; ?>&loja=<?php echo $loja; ?>&dataini=<?php echo $dataini; ?>&datafim=<?php echo $datafim; ?>" name="mainFrame" id="mainFrame" title="mainFrame" />
</frameset>
<noframes><body>
</body>
</noframes></html>