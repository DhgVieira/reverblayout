...
function confirma_baixa(idc) {
	var confirma = confirm("Confirma o cancelamento desta baixa?")
	if ( confirma ){
		document.location.href='contas_baixa_c.php?idc='+idc+'&tp=D';
	} else {
		return false
	} 
}
...
<script>
    function linha_baixada(id) {
        $("#"+id).css("background-color","#b6fcb6");
    }
</script>
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <div id="abas">
                   <div id="pagar">
                   <table width="885">
                   <tr><form action="contas_apagar.php" method="post" name="form1">
                   ...
                   <input name="tp" type="hidden" value="D" />
                	<ul class="compras">
                    <li>
                    <table border="0" cellpadding="0" cellspacing="2" height="20">
                            <tr>
                                <td width="21">&nbsp;</td>
                                <td align="center" width="112"><strong style="color:#993300;">Vencimento</strong></td>
                                ...
                                <td align="left" width="204"><strong style="color:#993300;">Descrição</strong></td>
                                ...
                                <td align="left" width="150"><strong style="color:#993300;">Descri&ccedil;&atilde;o</strong></td>
						...
						<?php
						  $sql = "select NR_SEQ_CONTA_CORC, NR_SEQ_CATCONTA_CORC, DS_DESCRICAO_CORC, VL_CONTA_CORC, DT_CADASTRO_CORC, DT_VCTO_CORC, DS_TIPO_CORC,
						  				DS_CATEGORIA_CCRC, DS_LOJA_LJRC, NR_SEQ_SUBCATCONTA_CORC, NR_FORMA_PGTO_CORC, ST_CONTA_CORC, NR_SEQ_DESCRICAO_CORC from contas, contas_categorias, lojas WHERE NR_SEQ_CATCONTA_CORC = NR_SEQ_CATCONTA_CCRC AND
						  ...
						  if (mysql_num_rows($st) > 0) {
							...
							?>
							<li id="linha<?php echo $id_conta; ?>" style="background-color: <?php echo $cssbg; ?>;">
                            <table border="0" width="1260" cellpadding="0" cellspacing="2" height="20">
                                <tr>
                                    ...
                                    <!--<td align="left" width="62"><?php echo $ds_loja;?></td>-->
                                    ...
                                    <?php if ($st_conta != "B"){ ?>
                                    <td align="center" width="25"><a href="contas_baixa.php?idc=<?php echo $id_conta;?>&tp=D&KeepThis=true&TB_iframe=true&height=180&width=300" class="thickbox" title="Dar Baixa"><img src="img/liberada.png" width="16" height="16" border="0" alt="Dar Baixa" /></a></td>
                                    <?php }else{ ?>
                                    <td align="center" width="25"><a href="#" onclick="confirma_baixa(<?php echo $id_conta; ?>);" title="Cancelar Baixa"><img src="img/check_icon.png" width="16" height="16" border="0" /></a></td>
                                    <?php } ?>
                                </tr>
                            </table>
                            </li>
