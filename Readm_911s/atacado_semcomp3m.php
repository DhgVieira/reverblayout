...
$consulta = "select count(*) from cadastros, compras where NR_SEQ_CADASTRO_CASO = NR_SEQ_CADASTRO_COSO
								...
								(select NR_SEQ_CADASTRO_COSO from compras where ST_COMPRA_COSO <> 'C' AND (DT_COMPRA_COSO > date_add(sysdate(),INTERVAL -90 DAY))))
...
$consulta .= " GROUP BY NR_SEQ_CADASTRO_COSO";
	...
	if ( confirma ){
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      <li id="abaVer" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Sem Compras 3 meses</li>
                      ...
                      <li id="abatipos" class="abainativa" onMouseOver="trataMouseAba(this);" onClick="document.location.href='clientes_lj.php';">Lojistas Cadastrados</li>
                    </ul>
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="2" height="20">
						...
						<?php
						  ...
						  $sql = "select NR_SEQ_CADASTRO_CASO, DS_LOGIN_CASO, DS_NOME_CASO, DS_CIDADE_CASO, DS_UF_CASO, DS_CEP_CASO, DS_EMAIL_CASO, DS_DDDFONE_CASO,
										...
										from cadastros, compras WHERE NR_SEQ_CADASTRO_CASO = NR_SEQ_CADASTRO_COSO
								and ST_COMPRA_COSO <> 'C' AND NR_SEQ_CADASTRO_CASO in
								(select NR_SEQ_CADASTRO_COSO from compras where ST_COMPRA_COSO <> 'C' AND NR_SEQ_CADASTRO_COSO not in 
								(select NR_SEQ_CADASTRO_COSO from compras, cadastros where NR_SEQ_CADASTRO_CASO = NR_SEQ_CADASTRO_COSO and
                                ST_COMPRA_COSO <> 'C' and TP_CADASTRO_CACH = 1 AND (DT_COMPRA_COSO > date_add(sysdate(),INTERVAL -90 DAY))))
                                and TP_CADASTRO_CACH = 1 ";
						  ...
						  $sql .= " GROUP BY NR_SEQ_CADASTRO_COSO order by DS_LOGIN_CASO LIMIT $primeiro_registro, $num_por_pagina";
