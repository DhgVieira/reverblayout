...
<title>Vendas Promoção tipograficas 3/Janeiro a 06/Janeiro</title>
...
?>
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT 
                                    ...
                                    FROM
                                        reverbcity22.cestas
                                            INNER JOIN
                                        produtos ON produtos.NR_SEQ_PRODUTO_PRRC = cestas.NR_SEQ_PRODUTO_CESO
                                    WHERE
                                             NR_SEQ_CATEGORIA_PRRC = 184
                                            and ((DT_INCLUSAO_CESO > '2014-01-03 08:00:00'
                                            and DT_INCLUSAO_CESO < '2014-01-06 08:00:00'))
                                    group by NR_SEQ_COMPRA_CESO";
 ...
 <?php $sql_total = "SELECT 
                    ...
                    INNER join
                        compras ON cestas.NR_SEQ_COMPRA_CESO = compras.NR_SEQ_COMPRA_COSO
                    INNER JOIN
                        produtos ON produtos.NR_SEQ_PRODUTO_PRRC = cestas.NR_SEQ_PRODUTO_CESO
                            WHERE
                        NR_SEQ_CADASTRO_COSO not in (8074 , 22364)
                    and NR_SEQ_LOJA_COSO = 1
                    AND NR_SEQ_CATEGORIA_PRRC = 184
                    and ((DT_COMPRA_COSO > '2014-01-03'
                    and DT_COMPRA_COSO < '2014-01-06 08:30:00'));";
        ...
        $sql_efetivo = "SELECT 
                        ...
                        INNER join
                            cestas ON cestas.NR_SEQ_COMPRA_CESO = compras.NR_SEQ_COMPRA_COSO
                        INNER JOIN
                            produtos ON produtos.NR_SEQ_PRODUTO_PRRC = cestas.NR_SEQ_PRODUTO_CESO
                        WHERE
                            NR_SEQ_LOJA_COSO = 1
                        ...
                        AND NR_SEQ_CATEGORIA_PRRC = 184
                        and ((DT_COMPRA_COSO > '2014-01-03 10:30:00'
                        and DT_COMPRA_COSO < '2014-01-06 08:30:00'))
                        ;";
        ...
        if (mysql_num_rows($st_efetivo) > 0) {
         ...
         $sql_aberto = "SELECT 
                    ...
                    INNER join
                        ...
                        AND ST_COMPRA_COSO = 'A'
                        AND NR_SEQ_CATEGORIA_PRRC = 184
                        and ((DT_COMPRA_COSO > '2014-01-03 08:00:00'
                        and DT_COMPRA_COSO < '2014-01-06 08:00:00'));";
