...
<title>Vendas Promoção Aniversário Reverb City - 10 anos</title>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    ST_COMPRA_COSO <> 'C' and ST_COMPRA_COSO <> 'A'  and NR_SEQ_TIPO_PRRC = 142
                            ...
                            if (mysql_num_rows($st) > 0) {
                                ...
                                while($row = mysql_fetch_row($st)) {
                                    ...
                                    <div style="text-align: center;"><strong><?php echo $qtde_estoq ?></strong></div>
                                      ...
                                      ?>
                                      <a href="/produto/<?php echo $ds_categoria ?>/<?php echo urlencode($ds_prod_url); ?>"><img src="/thumb/fotosprodutos/1/180/210/<?php echo $fotoRow[0]; ?>.<?php echo $fotoRow[2]; ?>" border="0" alt="<?php echo $ds_prod; ?>" width="120" /></a>
                                      <?php } ?>
