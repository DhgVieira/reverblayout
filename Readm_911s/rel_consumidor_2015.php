...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    and vl_frete_coso = 0
                                    and DT_COMPRA_COSO >= '2015-03-13 00:00:00'
                                    and DT_COMPRA_COSO < '2015-03-15 08:20:00'
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">Dia do Consumidor</strong></td>
            </tr>
            <tr bgcolor="silver">
        ...
        <?php
            ...
            $str = "SELECT 
                        COUNT(DS_FORMAPGTO_COSO) AS quantidade_total,
                    ...
                    FROM
                        ...
                        GROUP BY compras.nr_seq_compra_coso) AS temp
                    GROUP BY DS_FORMAPGTO_COSO";
