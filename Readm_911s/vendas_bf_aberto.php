...
<title>Vendas Black friday</title>
...
?>
    <div id="geral" style="background-color: white;">
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                     ...
                                     ST_COMPRA_COSO = 'A'  and
                                     ((DT_COMPRA_COSO > '2013-12-07 08:00:00'
                                     and DT_COMPRA_COSO < '2013-12-07 12:00:00'))
          ...
          $sql_aberto = "SELECT 
                            ...
                            WHERE
                                  NR_SEQ_LOJA_COSO = 1
                                    ...
                                    and ((DT_COMPRA_COSO > '2013-12-07 08:00:00'
                                    and DT_COMPRA_COSO < '2013-12-07 12:00:00'))";
        ...
        $st_aberto_pecas = mysql_query($sql_aberto_pecas);
 
        if (mysql_num_rows($st_aberto_pecas) > 0) {
            $rowaberto_pecas = mysql_fetch_row($st_aberto_pecas);
            
            $total_pecas = $rowaberto_pecas[0];
        }  
      ?>
        ...
        <center> <hr color="black" width="300px" height="3px"></center>
         <b> Valor total em aberto :</b> R$ <?php echo number_format($valor_aberto, 2, ",", ".")?></br><br />
          <b> Total de peças em aberto :</b> <?php echo $total_pecas ?></br><br />
         <center> <hr color="black" width="300px" height="3px"></center>
        <?php } ?>
        </div>
