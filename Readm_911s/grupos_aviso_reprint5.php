...
$PHP_SELF = "grupos_aviso_reprint5.php";
        	...
        	<tr>
            	<td height="20" align="center" class="textostabelas">
                	<ul id="titulos_abas">
                      ...
                      <li style="width: 120px;" id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_reprint5.php'">Bones</li>
                      <li style="width: 120px;" id="menuDepo5" onMouseOver="trataMouseAba(this);" class="abaativa">Canecas</li>
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <div id="listaprodutos" style="width: 990px;">
                            ...
                            and NR_SEQ_CATEGORIA_PRRC = 57 AND ST_JACOMPROU_AVRC = 'N' and NR_SEQ_LOJAS_PRRC = $SS_loja ";
