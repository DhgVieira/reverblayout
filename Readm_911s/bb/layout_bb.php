...
<div id="container">
	...
	<div id="">
<!--
  Use no lugar do <div id=""> caso queira imprimir sem o logotipo e instrues
  <div id="instructions">
 -->
...
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="logobb.jpg"></td>
			<td width=50>
		...
		<tr class="titulos">
            ...
            <td class="ag_cod_cedente">C&oacute;digo do Cedente</td>
		...
		<tr class="campos">
			...
			<td class="ag_cod_cedente" style="text-align: left;"><?php echo $dadosboleto["agencia_codigo"]?> &nbsp;</td>
			<td class="especie"><?php echo $dadosboleto["especie"]?>&nbsp;</td>
			<TD class="qtd"><?php echo $dadosboleto["quantidade"]?>&nbsp;</td>
			<TD class="nosso_numero"><?php echo $dadosboleto["nosso_numero"].'-X'?>&nbsp;</td>
		</tr>
		</tbody>
		</table>
		...
		<tr class="campos">
			<td class="num_doc"><?php echo substr($dadosboleto["numero_documento"],0,15)?></td>
