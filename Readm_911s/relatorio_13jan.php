...
<title>Vendas 11 a 13 Janeiro</title>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    ST_COMPRA_COSO <> 'C' and ST_COMPRA_COSO <> 'A' and ((DT_COMPRA_COSO > '2014-01-10 17:00:00'
                    				and DT_COMPRA_COSO < '2014-01-13 08:20:00'))
...
$sql_efetivo = "SELECT 
                    ...
                    and ((DT_COMPRA_COSO > '2014-01-10 17:00:00'
                    and DT_COMPRA_COSO < '2014-01-13 08:20:00'))";
...
$sql_cancelado = "SELECT 
                    ...
                    and ((DT_COMPRA_COSO > '2014-01-11 17:00:00'
                    and DT_COMPRA_COSO < '2014-01-13 08:20:00'));";
