...
<frameset rows="160,*" frameborder="no" border="0" framespacing="0">
  ...
  <frame src="rel_prodestoque0.php?aba=<?php echo $aba; ?>&loja=<?php echo $loja; ?>&tipo=<?php echo $tipo; ?>&ordem=<?php echo $ordem; ?>&status=<?php echo $status; ?>" name="mainFrame" id="mainFrame" title="mainFrame" />
</frameset>
<noframes><body>
</body>
</noframes></html>