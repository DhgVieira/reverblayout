        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7">
            <tr>
                <td align="left" height="18">
                    <ul id="titulos_abas">
                      <li id="menuDepo" class="abaativa" style="width:300px">Clientes que nunca compraram.</li>
                        ...
                        <tr>
                            <td align="left" height="68" bgcolor="#FFFFFF" valign="top">
                                ...
                                $compra = "SELECT 
                                        ...
                                        LEFT join
                                            compras on compras.NR_SEQ_CADASTRO_COSO = cadastros.NR_SEQ_CADASTRO_CASO
                                        where
                                           compras.NR_SEQ_CADASTRO_COSO is null
                                        GROUP BY NR_SEQ_CADASTRO_COSO
                                        ORDER by DT_COMPRA_COSO desc, total desc LIMIT $primeiro_registro, $num_por_pagina";
