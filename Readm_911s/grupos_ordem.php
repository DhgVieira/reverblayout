...
$(document).ready(function(){ 
	...
	$(function() {
		$("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("grupos_ordem_up.php", order, function(theResponse){
        	...
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      ...
                      <li id="abaPos" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Ordem Camisetas</li>
                      ...
                      <li id="abaPos7" class="abainativa" onMouseOver="trataMouseAba(this);" onClick="document.location.href='grupos_ordem_todos.php';">Ordem Todos</li>
                    </ul>
                </td>
            </tr>
            <tr>
        		...
        		<div id="Pos" style="width:1050px">                    
                    ...
                    <div id="contentLeft">
						 ...
						 <?php
                          ...
                          $sql .= "ORDER BY NR_ORDEM_PRRC, DT_CADASTRO_PRRC desc ";
