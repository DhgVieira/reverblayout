...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta charset="UTF-8">
        <title>Promo Tamanho XGG - 02/04/2015 - 09:00 as 17:20</title>
        <style>
            body {
            ...
            <tr>
                <td valign="top" align="center">
                    <div id="shop" style="background-color: white;">
                        <h2>Promo Tamanho XGG - 02/04/2015 - 09:00 a 17:20</h2>
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    ST_COMPRA_COSO <> 'C'
                                    and NR_SEQ_TAMANHO_CESO IN(33,47)
                                    and ((DT_COMPRA_COSO >= '2015-04-02 09:00:00'))
                                    and ((DT_COMPRA_COSO <= '2015-04-02 17:20:00'))
      ...
      <!-- Rodapé -->
        ...
        <?php
            ...
            $str = "SELECT 
                    ...
                    WHERE
                        ((DT_COMPRA_COSO >= '2015-04-02 09:00:00'))
                        and ((DT_COMPRA_COSO <= '2015-04-02 17:20:00'))
                        and NR_SEQ_TAMANHO_CESO IN(33,47)
