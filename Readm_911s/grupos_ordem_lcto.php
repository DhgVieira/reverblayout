...
$PHP_SELF = "grupos_ordem_lcto.php";
if (!$pagina) {
 $pagina = 1;
}
?>
...
$(document).ready(function(){ 
	...
	$(function() {
		$("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("grupos_ordem_up_lcto.php", order, function(theResponse){
        	...
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      ...
                      <li id="abaPos" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Ordem Lan&ccedil;amentos</li>
        		...
        		<div id="Pos" style="width:1050px">                    
                    ...
                    <div id="contentLeft">
						 ...
						 <?php
                          ...
                          $sql .= "AND (TP_DESTAQUE_PRRC = 1 or TP_DESTAQUE_PRRC = 4) ";
                          $sql .= "group by NR_SEQ_PRODUTO_PRRC ";
                          $sql .= "ORDER BY NR_ORDEM_LCTO_PRRC, DT_CADASTRO_PRRC desc ";
                ...
                $fotoRow = mysql_fetch_row($stFoto);
                      ...
                      <ul class="paginacao" style="width: 900px;">
                        ...
                        $consulta = "select count(*)
                                 from produtos, estoque, produtos_tipo WHERE NR_SEQ_PRODUTO_PRRC = NR_SEQ_PRODUTO_ESRC AND NR_SEQ_LOJAS_PRRC = 1
                                 AND DS_CLASSIC_PRRC = 'N' AND NR_QTDE_ESRC > 0 AND ST_PRODUTOS_PRRC = 'A' AND NR_SEQ_TIPO_PRRC = NR_SEQ_CATEGPRO_PTRC ";
                        $consulta .= "and (TP_DESTAQUE_PRRC = 1 or TP_DESTAQUE_PRRC = 4) ";
