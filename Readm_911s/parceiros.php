	...
	if ( confirma ){
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      <li id="abaParc" class="abainativa" onMouseOver="trataMouseAba(this);" onClick="document.location.href='sortecred.php';">Administrar Cr&eacute;ditos</li>
                      <li id="abaCreditos" class="abaativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Parceiros</li>
                    </ul>
                </td>
            </tr>
            <tr>
