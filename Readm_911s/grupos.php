...
function confirma_cla(idp) {
	var confirma = confirm("Tem certeza que voce deseja mover este produto para o Classics?")
	if ( confirma ){
...
function confirma_pro(idp,ext,ext2) {
	...
	if ( confirma ){
		document.location.href='grupos_del.php?&idp='+idp+'&ext='+ext+'&ext2='+ext2+'&pg=<?php echo $pagina ?>';
	} else {
		return false
	} 
}
                	...
                	<table width="100%">
                        <tr>
                        	...
                        	<ul id="titulos_abas">
                              ...
                              <li id="menuInativos" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_inativos.php'">Produtos Inativos</li>
                              <?php if ($SS_nivel >= 50) { ?>
                              <li id="menuDepo2" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso.php'">Produtos Avise-me</li>
                              <li id="menuDepo3" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_aviso_reprint.php'">Avise-me Reprint</li>
                              <?php } ?>
                              <?php if ($SS_loja == 1) { ?>
                              <li id="menuOrdem" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_ordem.php'">Ordem dos Produtos</li>
                              <li id="menuOrdem" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='grupos_marcados.php'">Produtos Marcados</li>
                              <?php if ($SS_nivel >= 100) { ?>
                              <li id="menuOrdem" onMouseOver="trataMouseAba(this);" class="abainativa" onclick="document.location.href='producao.php'">Previs&atilde;o de Produ&ccedil;&atilde;o</li>
                              <?php } ?>
                              <?php } ?>
                            </ul>
                            </td>
        	...
        	<tr>
            	<td align="left">
                	<ul id="titulos_abas">
                      ...
                      <li id="abaModel" class="abainativa" onMouseOver="trataMouseAba(this);" onClick="trataCliqueAba(this.id);">Modelos de Produtos</li>
                    </ul>
                </td>
            </tr>
            <tr>
                    ...
                    <div id="Ver">
                    	<table width="880">
                        	<tr>
								...
								?>
                            	<form action="grupos.php" method="post" name="frm">
               ...
               $select_fotos = "SELECT
                ...
                $fotoRow = mysql_fetch_row($stFoto);
							?>
							<li style="width:1085px;">
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            	<tr<?php if ($status == "I") echo " bgcolor=\"#FDEBDF\" "; ?>>
                                    <td align="left" width="20"><strong><?php echo $id_prod; ?></strong></td>
                                    ...
                                    <?php if ($ext == "swf") {?>
                                      <object data="../arquivos/uploads/produtos/<?php echo $id_prod; ?>.<?php echo $ext; ?>" type="application/x-shockwave-flash" width="31" height="36">
                                        ...
                                        <param name="movie" value="/images/produtos/<?php echo $id_prod; ?>.<?php echo $ext; ?>" />
                                        <param name="wmode" value="opaque" />
                                      </object>
                                    <?php }else{ ?>
                                	<img src="/thumb/fotosprodutos/1/31/36/<?php echo $fotoRow[0]; ?>.<?php echo $fotoRow[2]; ?>" width="31" height="36" border="0" />
                                	<?php } ?>
                                    </td>
                                    ...
                                    <?php if ($SS_nivel >= 50) { ?>
                                    <td align="center" width="25"><a href="grupos_comentarios.php?idp=<?php echo $id_prod;?>" title="Comentarios do Produto"><img src="img/chat.png" border="0" /></a></td>
                                    ...
                                    <?php if ($SS_nivel >= 100) { ?>
                                    <td align="center" width="25"><a href="producao.php?idp=<?php echo $id_prod;?>&pg=<?php echo $pagina; ?>" title="Previsao de Producao"><img src="img/ajax-loader.gif" width="16" height="16" border="0" /></a></td>
                                    <?php } ?>
                                    <td align="center" width="25"><a href="http://www.reverbcity.com/produto/previa-produto/<?php echo $id_prod ?>?preview=true" target="_blank" title="Visualizar"><img src="img/eye.png" width="16" height="16" border="0" /></a></td>
                                </tr>
                            </table>
                            </li>
							<?php
                      ...
                      <ul class="paginacao" style="width:1085px;">
						<?php
                        	...
                        	<tr>
                                ...
                                <table cellpadding="3" cellspacing="3">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <label for="codloc">
                                               <strong>C&oacute;digo Sistema Local:</strong><br />
                                                <input class="form00" type="text" name="codloc" style="width:150px;" />
                                             </label>
                                        </td>
                                    </tr>
                                    <tr>
                                      <td colspan="5">
                                            <label for="nome">
                                               ...
                                               <input class="form02" type="text" name="descricao2" style="width:435px;" />
                                             </label>
                                        </td>
                                    </tr>
                                    <tr>
                                   ...
                                   <!--  <tr>
                                    ...
                                    <tr>
                                      <td colspan="5" height="150">
                                        ...
                                        <textarea name="tags" width="500px" height="150" rows="5" cols="80"></textarea></label>
                                      </td>
                                    </tr>
                                </table>
                        	</td>
                                ...
                                <table width="370">
                                    ...
                                    <tr>
                                        <td height="30">
                                            ...
                                            <input name="destaque" type="radio" value="0" checked="checked" /> N&atilde;o 
                                            <input name="destaque" type="radio" value="1" /> New 
                                            <input name="destaque" type="radio" value="2" /> Sale 
                                            <input name="destaque" type="radio" value="3" /> Reprint
                                            <input name="destaque" type="radio" value="4" /> Pr&eacute;-Venda
                                            <input name="destaque" type="radio" value="5" /> 50%off
                                            <input name="destaque" type="radio" value="6" /> Topo loja 
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td height="30">
                                            ...
                                            <select name="status" class="form00" style="width:80px;height:23px;">
                                                ...
                                                <option value="P">Pre-Venda</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                    	<td >
                                        	<strong> Música do Produto (youtube):</strong><br />&nbsp;&nbsp;&nbsp;Ex: http://www.youtube.com/watch?v=XXUCFk8VJFY
                                    ...
                                    <tr>
                                    	<td height="30">
                                            ...
                                            <input type="text" name="textodestaq" style="width:150px" class="form00" maxlength="50" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="30">
                                            <strong>Aplicar Desconto p/ Lojistas?</strong> <input name="descloj" type="radio" value="S" /> Sim <input name="descloj" type="radio" value="N" checked="checked" /> N&atilde;o<br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="30">
                                            <strong>Participante das Promo&ccedil;&otilde;es?</strong> <input name="partpromo" type="radio" value="S" checked="checked" /> Sim <input name="partpromo" type="radio" value="N" /> N&atilde;o
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td height="40">
                                            ...
                                            <input type="text" name="ncmprod" style="width:150px" class="form00" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="30">
                                    ...
                                    <tr>
                                        <td height="30">
                                          ...
                                          <?php
                                           ...
                                           <!--  <strong>Cor :</strong> 
                                            <input name="cores" type="radio" value="1"<?php if ($cor == 1) echo " checked"; ?> /> Preto 
                                            <input name="cores" type="radio" value="2"<?php if ($cor == 2) echo " checked"; ?> /> Cinza
                                            <input name="cores" type="radio" value="3"<?php if ($cor == 3) echo " checked"; ?> /> Branco 
                                            <input name="cores" type="radio" value="4"<?php if ($cor == 4) echo " checked"; ?> /> Vermelho 
                                            <input name="cores" type="radio" value="5"<?php if ($cor == 5) echo " checked"; ?> /> Amarelo 
                                            <input name="cores" type="radio" value="6"<?php if ($cor == 6) echo " checked"; ?> /> Verde
                                            <input name="cores" type="radio" value="7"<?php if ($cor == 7) echo " checked"; ?> /> Azul 
                                            <input name="cores" type="radio" value="8"<?php if ($cor == 8) echo " checked"; ?> /> Marrom
                                            <input name="cores" type="radio" value="9"<?php if ($cor == 9) echo " checked"; ?> /> Roxo 
                                            <input name="cores" type="radio" value="10"<?php if ($cor == 10) echo " checked"; ?> /> Laranja
                                            <input name="cores" type="radio" value="11"<?php if ($cor == 11) echo " checked"; ?> /> Creme 
                                            <input name="cores" type="radio" value="12"<?php if ($cor == 12) echo " checked"; ?> /> Rosa 
                                            -->
                                            <br />
                                        </td>
                                    </tr>
                    ...
                    <div id="Categ">
                    	...
                    	<form action="prod_cat_inc.php" method="post">
                                 <ul class="formularios">
                                   ...
                                   <li>
                                     <label for="ncm">
                                       ...
                                       <input class="form01" type="text" id="ncm" name="ncm" />
                                     </label>
                                   </li>
                                   <li>
                          ...
                          <ul class="noticias">
                            ...
                            <?php
                              $sql = "select NR_SEQ_CATEGPRO_PCRC, DS_CATEGORIA_PCRC, NR_SEQ_LOJA_PCRC, DS_NCM_PCRC from produtos_categoria order by DS_CATEGORIA_PCRC";
                              $st = mysql_query($sql);
                              ...
                              if (mysql_num_rows($st) > 0) {
                                ...
                                <div><a href="prod_cat_alt.php?idc=<?php echo $id_cat;?>" title="Alterar"><img src="img/ico-det.gif" width="16" height="16" border="0" /></a></div>
                                <div><strong><?php echo $ncmcat ?></strong></div>
                                <?php } ?>
                                </li>
                                <?php
                                }
            		...
            		<div id="Tipos">
                    	...
                    	<form action="prod_tipo_inc.php" method="post">
                          ...
                          <ul class="noticias">
                            ...
                            <?php
                              $sql = "select NR_SEQ_CATEGPRO_PTRC, DS_CATEGORIA_PTRC, NR_SEQ_LOJA_PTRC, DS_NCM_PTRC from produtos_tipo order by DS_CATEGORIA_PTRC";
                              $st = mysql_query($sql);
                              ...
                              if (mysql_num_rows($st) > 0) {
                                ...
                                <div><a href="prod_tipo_alt.php?idc=<?php echo $id_tip;?>" title="Alterar"><img src="img/ico-det.gif" width="16" height="16" border="0" /></a></div>
                                <div><strong><?php echo $ncmtipo ?></strong></div>
                                <?php } ?>
                                </li>
                                <?php
                                }
                    ...
                    <div id="Model">
                      <div style="width: 100px;margin-left: 30px;margin-top: 20px;margin-bottom: 20px;">
                        <a href="novo_modelo.php" style="padding: 10px;background-color: #5fbf98;text-decoration: none;color: #FFF;font-weight: bold;">Novo modelo </a>
                      </div>
                        ...
                        <ul class="noticias">
                          ...
                          <?php
                              $sql = "SELECT idmodelo, descricao, modelo_ativo from modelos order by idmodelo ASC";
                              $st = mysql_query($sql);
                              ...
                              if (mysql_num_rows($st) > 0) {
                                ...
                                ?>
                                <li>
                                <span><strong><?php echo $descricao;?></strong></span>
                                <?php if ($SS_loja == $nr_loja) { ?>
                                <div>
                                <a href="nova_medida.php?idmodel=<?php echo $id_modelo;?>" title="inserir medida" ><img src="img/medidas.png" width="16" height="16" /></a>
                                </div>
                                <div>
                                <a href="#" title="deletar musica" onclick="confirma_mus(<?php echo $id_modelo; ?>);"><img src="img/cancel.png" width="16" height="16" /></a>
                                </div>
                                <?php } ?>
                                </li>
                                <?php
