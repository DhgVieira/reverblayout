...
<input type="hidden" name="assunto" value="Relatorio Movimento do Mes" />
<table width="820" >
	<tr>
    	<td>&nbsp;</td>
	...
	<tr>
        ...
        <td class="font16" align="center" height="70"><strong>Movimento do Mês</strong><br /><font class="font12"><? echo $mes.'/'.$ano;?></font></td>
...
<table>
	<tr>
    	<td height=70 align=left class=fontlogo width=200><strong>ReverbCity</strong></td>
        <td class=font16 align=center height=70><strong>Movimento do Mês</strong><br /><font class=font12>". $mes.'/'.$ano."</font></td>
	...
	$sql = "select NR_SEQ_CONTA_CORC, NR_SEQ_CATCONTA_CORC, DS_DESCRICAO_CORC, VL_CONTA_CORC, DT_CADASTRO_CORC, DT_VCTO_CORC, DS_TIPO_CORC,
     ...
     $x=0;
			...
			$corpo .= "<tr  bgcolor=".$bg.">
						  ...
						  <td align=center width=20><strong>".$ds_tipo."</strong></td>
					  </tr>";
		...
		$sq = "select NR_SEQ_COMPRA_COSO, DT_COMPRA_COSO, DT_STATUS_COSO, VL_TOTAL_COSO, ST_COMPRA_COSO 
			from compras 
	...
	if( mysql_num_rows($st2) > 0 ){
		while ($row2 = mysql_fetch_row($st2)){
			...
			$corpo.="</td>
                ...
                <td align=center width=20><strong>".$stStatus."</strong></td>                
			</tr>";
