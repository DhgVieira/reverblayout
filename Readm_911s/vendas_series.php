...
?>
	<div id="geral" style="background-color: white;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    DS_FRETEGRATIS_PRRC, VL_PROMO_PRRC, DS_CATEGORIA_PTRC, SUM(NR_QTDE_CESO) as total, DT_COMPRA_COSO , SUM(VL_PRODUTO_CESO) as vl_prod from compras, cestas, produtos, produtos_tipo where 
                                    ...
                                    NR_SEQ_LOJAS_PRRC = 1 ";
                            $sql .= "AND NR_SEQ_TIPO_PRRC = 6 and NR_SEQ_CATEGORIA_PRRC = 178 ";
                            $sql .= " GROUP BY NR_SEQ_PRODUTO_CESO, month(DT_COMPRA_COSO), year(DT_COMPRA_COSO) ORDER by DT_COMPRA_COSO desc";
                            ...
                            if (mysql_num_rows($st) > 0) {
                                ...
                                while($row = mysql_fetch_row($st)) {
                                   ...
                                   $nova_data = explode('-', $data_venda);

                                   $dia = explode(" ", $nova_data[2]);
                                   ...
                                   $data_formatada = $mes."/".$nova_data[0];
                                    ...
                                    ?>
                                    <div class="produto"  style="margin: 0 0 5px 6px;position: relative; z-index:1; height: 231px;">
                                    <div style="text-align: center;"><strong><?php echo $qtde_estoq ?> - <p>R$ <?php echo number_format($vl_total, 2, ",", ".")?><p></strong>
                                    <p><b><?php echo $data_formatada ?></b></p></div>
                                  	  <?php if ($ds_ext == "swf") {?>
          ...
          Quantidade Total: <?php echo $qtde_total ?> - R$ <?php echo number_format($valor_soma, 2, ",", ".")?>
        </div>
