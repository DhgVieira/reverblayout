...
<?php include 'topo.php'; ?>
    ...
    <script src="scripts/google.puc.min.js" type="text/javascript"></script>
        ...
        <tr>
            <td height="20" align="center" class="textostabelas">
                <ul id="titulos_abas">
                    ...
                    <li id="menuDepo" class="abainativa" onMouseOver="trataMouseAba(this);"
                        onClick="document.location.href='graficos.php';">GR&Aacute;FICOS
                    </li>
                </ul>
            </td>
        </tr>
    ...
    <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left">
                <ul id="titulos_abas">
                    <li id="abaVend" class="abaativa" onMouseOver="trataMouseAba(this);"
                        onClick="trataCliqueAba(this.id);">GERAIS
                    </li>
                    <li id="abaProd" class="abainativa" onMouseOver="trataMouseAba(this);"
                        onClick="trataCliqueAba(this.id);">PRODUTOS
                    </li>
                    <li id="abaCome" class="abainativa" onMouseOver="trataMouseAba(this);"
                        onClick="trataCliqueAba(this.id);">COMÉRCIO
                    </li>
                    <li id="abaAdm" class="abainativa" onMouseOver="trataMouseAba(this);"
                        onClick="trataCliqueAba(this.id);">CONTAS ADM
                    </li>
                    <li id="abaMkt" class="abainativa" onMouseOver="trataMouseAba(this);"
                        onClick="trataCliqueAba(this.id);">MARKETING
                    </li>
                </ul>
            </td>
        </tr>
                                ...
                                <div id="vendas">
                                    <table width="885">
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendasdia.php" method="post" name="formvd">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas Diárias Líquidas</strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Resumo de todas as Vendas de um dia
                                                                específico
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    style="width:100px;height:14px;text-align:center;"
                                                                    class="frm_pesq" type="text" name="datadiavd"
                                                                    value="<?php echo str_pad($diaanterior[2], 2, "0", STR_PAD_LEFT) . "/" . str_pad($diaanterior[1], 2, "0", STR_PAD_LEFT) . "/" . $diaanterior[0] ?>"/>
                                                                <a href="javascript:calvd.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                            <td><input class="frm_pesq" type="submit"
                                                                       value="Exibir Relat&oacute;rio"/></td>
                                                        </tr>
                                                    </form>
                                                </table>
                                            </td>
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendasdiabanco.php" method="post" name="formvd2">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas Diárias (sem taxas)</strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Resumo de todas as Vendas do Mês, dia a dia
                                                                para verificação de entradas em bancos
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input style="width:30px;height:14px;text-align:center;"
                                                                       class="frm_pesq" type="text" name="mes"
                                                                       value="<?php echo date("m"); ?>"/>
                                                                <input style="width:40px;height:14px;text-align:center;"
                                                                       class="frm_pesq" type="text" name="ano"
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendasteesuf.php" method="post" name="formvd3">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas de Camisetas por
                                                                    Estados</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Quantidade de Camisetas vendidas, dia a dia,
                                                                por estados
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendas_uf.php" method="post" name="formvd4">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas de itens por Estados</strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Quantidade de itens vendidos, dia a dia, por
                                                                estados
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_atividade_equip.php" method="post"
                                                          name="formvd3">
                                                        <input name="aba" type="hidden" value="V"/>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Atividade da Equipe no Site</strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Resumo da participação dos funcionários no
                                                                Site
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_venda_atacado.php" method="post" name="formvd3">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas de Atacado</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Vendas de Atacado com c&aacute;lculo de
                                                                comiss&otilde;es
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    ...
                                                    <form action="fram_frete.php" method="post" name="form12">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Informações de frete </strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todos os cruzamentos de informações de
                                                                fretes.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    style="width:100px;height:14px;text-align:center;"
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    style="width:100px;height:14px;text-align:center;"
                                                                    class="frm_pesq" type="text" name="datafinal"
                                                                    value="<?php echo $datafinal; ?>"/> <a
                                                                    href="javascript:cald2.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_maisvendtam.php" method="post" name="formvd2">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Média Mais Vendidos</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Resumo dos 40 produtos mais vendidos, com
                                                                qtde total e média mensal por tamanho
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_maisvend.php" method="post" name="formvd2">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Produtos Mais Vendidos</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Resumo dos 50 produtos mais vendidos no site
                                                                com total
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_estoqueatual.php" method="post" name="form3">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Estoque Atual</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista o estoque atual da loja escolhida
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select name="loja"><?php echo $str_lojas; ?></select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                ...
                                                <table>
                                                    <form action="fram_produtosmes.php" method="post" name="formvd2">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Produtos Vendidos</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Resumo de todos os produtos vendidos no
                                                                Mês
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_prodestoq.php" method="post" name="form0">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Produtos Com Estoque</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todos os produtos cadastros com
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select name="loja">
                                                                    ...
                                                                    </option><?php echo $str_lojas; ?></select></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            ...
                                                            <td><select name="tipo">
                                                                    ...
                                                                    </option><?php echo $str_tipos; ?></select></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select name="ordem">
                                                                    <option value="0">Mais Estoque</option>
                                                                    <option value="1">Menos Estoque</option>
                                                                    <option value="2">Descrição do Produto</option>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select name="catcat">
                                                                    <option value="0">Todas
                                                                    </option><?php echo $strcat; ?></select></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td><strong>Tamanho: </strong></td>
                                                            <td><select name="tamtam">
                                                                    <option value="0">Todos
                                                                    </option><?php echo $tamprod; ?></select></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_prodestoq0.php" method="post" name="form1">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Produtos Sem Estoque</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todos os produtos cadastrados que não
                                                                possuem estoque.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><strong>Ordenação: </strong></td>
                                                            <td><select name="ordem">
                                                                    <option value="0">Descrição do Produto</option>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_prodvendas.php" method="post" name="form2">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todos os produtos vendidos por
                                                                período.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    style="width:100px;height:14px;text-align:center;"
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_prodtam.php" method="post" name="form3">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Produtos Por Tamanhos</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todos os produtos cadastros de acordo
                                                                com os tamanhos desejados e as respectivas quantidades
                                                                em estoque.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td><strong>Tamanho: </strong></td>
                                                            <td><select name="taman">
                                                                    <option value="0">Todos
                                                                    </option><?php echo $str_tam; ?></select></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td><strong>Ordenação: </strong></td>
                                ...
                                <div id="comercio">
                                    <table width="885">
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendasper.php" method="post" name="form4">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas por Período</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todos as vendas realizadas em um
                                                                período determinado.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select name="ordem">
                                                                    ...
                                                                    <option value="1">Maior Compra</option>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendasestado.php" method="post" name="form5">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas por Estados</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista a quantidade de produtos vendidos por
                                                                estados.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendascategoria.php" method="post"
                                                          name="formcat1">
                                                        <input name="aba" type="hidden" value="C"/>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas por
                                                                    Categoria/Tamanho</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas a vendas realizadas por
                                                                categoria/tamanho.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:calcat.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                                                    href="javascript:calcat2.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendascliente.php" method="post" name="formcli">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas por Cliente</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista a quantidade de produtos vendidos por
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:calcli.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                                                    href="javascript:calcli2.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select name="tipo">
                                                                    <option value="0">Todos
                                                                    </option><?php echo $str_cliente; ?></select></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                ...
                                <div id="adm">
                                    <table width="885">
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_movdia.php" method="post" name="formdia">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Movimento do dia</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as contas a pagar e recebidas
                                                                por vencimento, e as compras pagas por data do status em
                                                                determinado dia por loja.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:caldia.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_movmes.php" method="post" name="formmes">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Movimento Mensal</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as contas a pagar e recebidas
                                                                por vencimento, e as compras pagas por data do status em
                                                                determinado mês por loja.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:calmes.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_contaspagar.php" method="post" name="form6">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Contas a Pagar</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as contas a pagar por loja em um
                                                                período determinado por vencimento.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                                                    href="javascript:cal8.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_contasreceber.php" method="post" name="form7">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Contas a Receber</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as contas a receber por loja em
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:cal9.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                                                    href="javascript:cal10.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_contaspagas.php" method="post" name="formp">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Contas Pagas</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as contas Pagas por loja em um
                                                                período determinado por vencimento.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:calp1.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                                                    href="javascript:calp2.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_contasrecebidas.php" method="post" name="formr">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Contas Recebidas</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as contas Recebidas por loja em
                                                                um período determinado.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:calr1.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                                                    href="javascript:calr2.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                        ...
                                        <tr>
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_contasunificadas.php" method="post" name="form8">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Contas a Unificadas</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as contas unificadas por loja em
                                                                um período determinado.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:cal11.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                                                    href="javascript:cal12.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_contasespecificas.php" method="post"
                                                          name="form9">
                                                        <input name="aba" type="hidden" value="A"/>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Contas Específicas</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as contas específicas por loja
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:calA.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/> <a
                                                                    href="javascript:calB.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select
                                                                    name="categoria"><?php echo $contascat; ?></select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_contassubcontas.php" method="post" name="form10">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Subcontas Específicas</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todas as subcontas específicas por
                                                                loja em um período determinado.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    ...
                                                                    class="frm_pesq" type="text" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/> <a
                                                                    href="javascript:calc.popup();"><img
                                                                        src="img/cal.gif" width="16" height="16"
                                                                        border="0"
                                                                        alt="Clique aqui para escolher a data"
                                                                        align="absmiddle"></a></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><strong>Específica: </strong></td>
                                                            <td><select
                                                                    name="subcategoria"><?php echo $contassubcat; ?></select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_pontos.php" method="post" name="form11">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Pontos de clientes </strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todos os clientes com a quantidade de
                                                                pontos.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                ...
                                <div id="marketing">
                                    <table width="885">
                                        <tr>
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_vendasgenero.php" method="post" name="form13">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Vendas por Sexo</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista todos as vendas realizadas em um
                                                                período determinado de cada sexo.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><strong>Data Inicial: </strong></td>
                                                            <td><input
                                                                    style="width:140px;height:14px;text-align:center;"
                                                                    class="frm_pesq" name="dataini"
                                                                    value="<?php echo $dataini; ?>"/></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td><strong>Data Final: </strong></td>
                                                            <td><input
                                                                    style="width:140px;height:14px;text-align:center;"
                                                                    class="frm_pesq" name="datafim"
                                                                    value="<?php echo $datafim; ?>"/></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="clientes_maiores_comp.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Maiores Compradores</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os maiores compradores do site até a
                                                                presente data.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                            <td><input class="frm_pesq" type="submit"
                                                                       value="Exibir Lista dos Maiores Compradores"/>
                                                            </td>
                                                        </tr>
                                                    </form>
                                                </table>
                                                <br/>
                                                <table>
                                                    <form action="clientes_maiores_band.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Maiores Compradores Tshirts
                                                                    Banda</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os maiores compradores de tshirts de
                                                                Bandas do site até a presente data.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                            <td><input class="frm_pesq" type="submit"
                                                                       value="Exibir Lista dos Maiores Compradores Bandas"/>
                                                            </td>
                                                        </tr>
                                                    </form>
                                                </table>
                                        ...
                                        <tr>
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="clientes_nunca_comp_m.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Homens que nunca Compraram
                                                                    (<?php echo $totcadsM ?>)</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os cadastros masculinos que nunca
                                                                realizaram compras.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                            <td><input class="frm_pesq" type="submit"
                                                                       value="Exibir Lista"/></td>
                                                        </tr>
                                                    </form>
                                                </table>
                                                <br/>
                                                <table>
                                                    <form action="clientes_nunca_comp_f.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Mulheres que nunca Compraram
                                                                    (<?php echo $totcadsF ?>)</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os cadastros femininos que nunca
                                                                realizaram compras.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="clientes_nao_comp1ano_m.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Homens que não compram a 1 ano
                                                                    (<?php echo $totcadsM1 ?>)</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os cadastros masculinos que não
                                                                realizam compras a 1 ano.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                ...
                                                <br/>
                                                <table>
                                                    <form action="clientes_nao_comp1ano_f.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Mulheres que não compram a 1 ano
                                                                    (<?php echo $totcadsF1 ?>)</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os cadastros femininos que não
                                                                realizam compras a 1 ano.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="clientes_compras6meses_f.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Mulheres que que realizaram compras
                                                                    a 6 meses (<?php echo $totcadsF6 ?>)</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os cadastros femininos que realizaram
                                                                compras a 6 meses.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <br/>
                                                <table>
                                                    <form action="clientes_compras6meses_m.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Homens que que realizaram compras a
                                                                    6 meses (<?php echo $totcadsM6 ?>)</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os cadastros masculinos que realizaram
                                                                compras a 6 meses.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="clientes_maiores_comp_estado.php" method="post"
                                                          name="form14">
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os 5 maiores compradores do site de
                                                                cada estado (fora lojistas).
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                            <td><input class="frm_pesq" type="submit"
                                                                       value="Exibir Lista dos 5 Maiores Compradores"/>
                                                            </td>
                                                        </tr>
                                                    </form>
                                                </table>
                                                ...
                                                <table>
                                                    <form action="fram_novoscadastros.php" method="post" name="form13">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Novos Cadastros</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Mostra a quantidade de cadastros realizados
                                                                no mês por sexo.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="fram_maisvendidos.php" method="post" name="form13">
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Mostra uma listagem com os produtos mais
                                                                vendidos
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td><strong>Tipo do produto: </strong></td>
                                                            <td><select name="tipo">
                                                                    <option value="0">Todos
                                                                    </option><?php echo $str_tipos; ?></select></td>
                                                        </tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <table>
                                                    <form action="clientes_maiores_comp.php" method="get" name="form99">
                                                        <input name="aba" type="hidden" value="M"/>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2"><strong>Maiores Compradores por Cidade</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
                                                            <td colspan="2">Lista os maiores compradores por cidade selecionada
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30">&nbsp;</td>
