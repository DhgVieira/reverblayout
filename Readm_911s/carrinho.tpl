...
{if $msg_promo neq ""}
    ...
    {if $primeira_compra eq 1 and $compra_niver eq 0}
        <img src="{$basePath}/arquivos/default/images/bag-icon.png"style="float: left;padding: 10px;">
    {/if}
...
{else}
    <h2 style="background-color: #e85238; color: #FFF; padding: 10px 10px 10px 10px; font-size: 13px;">
        <img src="{$basePath}/arquivos/default/images/bag-icon.png"style="float: left;padding: 10px;">
        <b>
            Compre 1 camiseta fora de promo e ganhe outra camiseta surpresa! Basta efetuar uma compra que mandamos pra vc, não precisa fazer nenhuma ação no carrinho. Vc não poderá escolher e nem trocar  a camiseta surpresa. Promo não cumulativa
        </b>
       <!--  <img src="{$basePath}/arquivos/default/images/rocket-icon.png"style="float: left;padding-right: 10px;">
        {if $cidade_usuario eq 'Londrina'}
             <b>Faça uma compra a partir de R$69 em qualquer item fora de promoção e  ganhe o frete para Londrina. Promo não cumulativa com a de aniversário.</b>
        {else}
    ...
    <ul class="my-cart-content-wrapper">
        ...
        {if $dadosProduto['tipo'] neq 9}
            <li class="my-cart-content-item" data-idestoque="{$dadosProduto['idestoque']}" data-valorproduto="{$valor_produto}">
                <div class="content-item product-name">
                    {if file_exists("arquivos/uploads/produtos/$foto_completa")}
                        ...
                        <span data-picture data-alt="{$dadosProduto['titulo']}" data-title="{$dadosProduto['titulo']}">
                            <span data-src="{$this->Url(['tipo'=>"produtos", 'crop'=>1, 'largura'=>65, 'altura'=>70, 'imagem'=>$foto_completa], "imagem", TRUE)}"></span>
                            <!-- for hd displays -->
                            <span data-width="65" data-height="70" data-src="{$this->Url(['tipo'=>"produtos", 'crop'=>1, 'largura'=>130, 'altura'=>140, 'imagem'=>$foto_completa], "imagem", TRUE)}" data-media="(-webkit-min-device-pixel-ratio: 2.0)"></span>

                            <noscript>
                                <img src="{$this->Url(['tipo'=>"produtos", 'crop'=>1, 'largura'=>65, 'altura'=>70, 'imagem'=>$foto_completa], "imagem", TRUE)}" alt="Imagem não encontrada - Reverbcity">
                            </noscript>
                        </span>
                    {else}
                        <!-- Polyfill para imagens responsivas-->
                ...
                <div class="content-item product-description" style="
    padding: 23px;">
