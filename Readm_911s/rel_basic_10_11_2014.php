...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    and ((DT_COMPRA_COSO >= '2014-11-10 00:00:00'))
                                    and ((DT_COMPRA_COSO <= '2014-12-01 23:59:59'))
                                    and NR_SEQ_CATEGORIA_PRRC = 179
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">BASICS 10/11/2014</strong></td>
            </tr>
            <tr bgcolor="silver">
        ...
        <?php
            ...
            $str = "SELECT 
                    ...
                    WHERE
                        compras.DT_COMPRA_COSO >= '2014-11-10 00:00:00'
                        and DT_COMPRA_COSO <= '2014-12-01 23:59:59'
                        and NR_SEQ_CATEGORIA_PRRC = 179
