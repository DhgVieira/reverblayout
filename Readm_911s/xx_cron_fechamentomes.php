...
$subject  = utf8_encode("Reverbcity - Relatórios de fechamento do mês ".$mesant);
...
foreach ($contatos as $key => $contato) {
	EnviaMailer("atendimento@reverbcity.com","Reverbcity",$contato,$key,"",$subject,utf8_encode($corpo));
}
