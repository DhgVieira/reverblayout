...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <div id="listaprodutos" style="width: 990px;">
                            ...
                            $primeiro_registro = ($pagina*$num_por_pagina) - $num_por_pagina;
                             ...
                             $sql = "SELECT NR_SEQ_PRODUTO_PRRC, VL_PRODUTO_PRRC, DS_PRODUTO2_PRRC, DS_EXT_PRRC, TP_DESTAQUE_PRRC, 
                                    ...
                                    AND NR_SEQ_PRODUTO_PRRC in(5766,5765, 5763, 5764, 5762, 5761)
      ...
      <!-- Rodapé -->
        ...
        <table align="center">
            <tr>
                <td align="center" colspan="3"><strong style="font-size: 25px;">Muse</strong></td>
            </tr>
            <tr bgcolor="silver">
        ...
        <?php
            ...
            $str = "SELECT 
                    ...
                    WHERE
                        NR_SEQ_PRODUTO_CESO in(5766,5765, 5763, 5764, 5762, 5761)
        ...
        <table align="center">
            ...
            $str_total = "SELECT 
                        ...
                        WHERE
                            ...
                            AND compras.ST_COMPRA_COSO <> 'C' group by NR_SEQ_COMPRA_COSO";
