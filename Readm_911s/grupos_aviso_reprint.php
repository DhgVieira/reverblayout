      ...
      <table class="textosjogos" cellpadding="0" cellspacing="0">
        ...
        <table class="textosjogos" cellpadding="0" cellspacing="0">
          <tr>
              <td height="20" align="center" class="textostabelas">
                  <ul id="titulos_abas">
                      <li style="width: 120px;" id="menuDepo" onMouseOver="trataMouseAba(this);" class="abaativa">Tees Bandas</li>
        ...
        <table class="textostabelas" width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <?php
                            ...
                            and NR_SEQ_TIPO_PRRC = 6 and NR_SEQ_CATEGORIA_PRRC in (7,8,11,10) AND ST_JACOMPROU_AVRC = 'N' and NR_SEQ_LOJAS_PRRC = $SS_loja 
