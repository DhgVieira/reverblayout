...
<input type="hidden" name="assunto" value="Relatorio de Subcontas Específicas" />
...
<table width="820" >
	...
	<tr>
        ...
        <td class="font16" align="center" height="70"><strong>Relatório de Subcontas Específicas</strong><br /><font class="font12"><? echo $dataini.' - '.$datafim;?></font></td>
...
<body><table width=820>
	...
	<tr>
    	<td height=70 align=left class=fontlogo width=200><strong>ReverbCity</strong></td>
        <td class=font16 align=center height=70><strong>Relatório de Subcontas Específicas</strong><br /><font class=font12>".$dataini.' - '.$datafim."</font></td>
...
<table width=820 class=font12>
	...
	$sql = "select NR_SEQ_CONTA_CORC, NR_SEQ_CATCONTA_CORC, DS_DESCRICAO_CORC, VL_CONTA_CORC, DT_CADASTRO_CORC, DT_VCTO_CORC, DS_TIPO_CORC,
										...
										NR_SEQ_LOJA_CORC = NR_SEQ_LOJA_LJRC and NR_SEQ_SUBCATCONTA_CORC = $subcategoria AND DS_TIPO_CORC = 'D' AND NR_SEQ_LOJA_CORC = $loja AND
		...
		?>
            ...
            <?php
            $corpo .= "<tr><td colspan=7 height=2></td></tr>
       		<tr>
				<td align=left><strong>Total Geral</strong></td>
				<td align=left></td>
				<td align=left></td>
